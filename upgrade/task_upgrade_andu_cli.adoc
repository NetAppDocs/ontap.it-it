...
NOTE: Se stai eseguendo l'upgrade di ONTAP in una configurazione FC di MetroCluster, devi anche verificare che il cluster sia abilitato per lo switchover automatico e non pianificato.
