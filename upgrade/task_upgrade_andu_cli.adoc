...
NOTE: Se si esegue l'aggiornamento da ONTAP 9.3 a 9.7, scaricare il pacchetto software per ONTAP 9.5, quindi utilizzare lo stesso comando per scaricare il pacchetto software per 9.7. Se si esegue l'aggiornamento da ONTAP 9.5 a 9.9.1, scaricare il pacchetto software per ONTAP 9.7, quindi utilizzare lo stesso comando per scaricare il pacchetto software per 9.9.1.
...
** Se si esegue l'aggiornamento da ONTAP 9.3 a 9.7, utilizzare il pacchetto 9.7 per la verifica. Non è necessario validare il pacchetto 9.5 separatamente.
** Se si esegue l'aggiornamento da ONTAP 9.5 a 9.9.1, utilizzare il pacchetto 9.9.1 per la verifica. Non è necessario validare il pacchetto 9.7 separatamente.
...
+
** Se si esegue l'aggiornamento da ONTAP 9.3 a 9.7, utilizzare il numero di versione del pacchetto 9.7 nel comando precedente.
** Se si esegue l'aggiornamento da ONTAP 9.5 a 9.9.1, utilizzare il numero di versione del pacchetto 9.9.1 nel comando precedente.
...
NOTE: Se si sta aggiornando una configurazione MetroCluster a 4 o 8 nodi, il `cluster image show-update-progress` command visualizza solo l'avanzamento del nodo su cui viene eseguito il comando. È necessario eseguire il comando su ciascun nodo per visualizzare l'avanzamento dei singoli nodi.
...
.. Verificare che sia stato attivato lo switchover automatico non pianificato ripetendo il passaggio 1.
