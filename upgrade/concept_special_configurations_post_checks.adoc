...
| È stato eseguito l'aggiornamento da ONTAP 9,7 o versione precedente a ONTAP 9,8 o versione successiva? | xref:task_verifying_your_network_configuration_after_upgrade.html[Verificare la configurazione di rete]
