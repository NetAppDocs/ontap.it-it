...
---
= Aggiorna una configurazione MetroCluster ONTAP a due nodi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Se si dispone di una configurazione MetroCluster a due nodi con ONTAP 9.3 o versioni successive, utilizzare i passaggi della CLI descritti in link:automated-upgrade-task.html["Installa l'immagine ONTAP con l'aggiornamento ONTAP automatico e senza interruzioni"].
