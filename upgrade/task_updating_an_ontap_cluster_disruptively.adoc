...
---
= Upgrade manuale con interruzione mediante CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* È necessario soddisfare i requisiti di preparazione.
+
In particolare, è necessario scaricare e installare l'immagine software utilizzando la procedura link:task_download_and_install_ontap_software_image.html#for-manual-upgrades["per gli aggiornamenti manuali"].
