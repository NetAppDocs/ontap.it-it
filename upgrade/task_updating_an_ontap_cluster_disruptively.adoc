...
---
= Aggiorna manualmente un cluster ONTAP in modo dirompente
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Devi usare l'interfaccia a riga di comando (CLI) di ONTAP per eseguire un aggiornamento manuale che causa interruzioni.
