...
| Si utilizza S3 SnapMirror e si esegue l'aggiornamento a ONTAP 9.12.1 o versione successiva? | link:considerations-for-s3-snapmirror-concept.html["Verifica della licenza per le configurazioni di S3 SnapMirror"] 
