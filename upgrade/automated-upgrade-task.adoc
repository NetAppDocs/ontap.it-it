...
NOTE: Se si esegue l'aggiornamento a ONTAP 9.15.1 o versione successiva tramite NetApp, seguire le istruzionilink:https://docs.netapp.com/us-en/console-software-updates/get-started/software-updates.html["procedura di aggiornamento nella documentazione della console NetApp"^] .
...
+
<<<<<<< HEAD Per l'FTP anonimo, è necessario specificare l'URL nel formato +ftp://anonymous@ftpserver+.



[]
=====
Per FTP anonimo, è necessario specificare l'URL nel formato \ftp://anonymous@ftpserver. >>>>>>> 20a8478e44f7b38038f6e148d4bfb0026800d5ff
