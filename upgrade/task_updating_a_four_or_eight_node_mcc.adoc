...
---
= Manuale ONTAP NDU su una configurazione MetroCluster a quattro o otto nodi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Un aggiornamento manuale non invasivo (NDU) di una configurazione MetroCluster a quattro o otto nodi prevede la preparazione all'aggiornamento, l'aggiornamento simultaneo delle coppie DR in ciascuno dei gruppi DR (uno o due) e l'esecuzione delle attività post-aggiornamento.

.A proposito di questa attività
* Devi usare l'interfaccia a riga di comando (CLI) di ONTAP per eseguire questa operazione.
...
----
+
L'esempio seguente mostra che l'immagine di sistema2 (target ONTAP image) è la versione predefinita e corrente sul nodo_A_1:
...
----
+
L'esempio seguente mostra che l'immagine di sistema2 (immagine ONTAP di destinazione) è la versione predefinita e corrente sul nodo_B_1:
...
----
+
L'esempio seguente mostra che l'immagine di sistema2 (immagine ONTAP di destinazione) è la versione predefinita e corrente sul nodo_A_2:
...
----
+
L'esempio seguente mostra che l'immagine di sistema2 (immagine ONTAP di destinazione) è la versione predefinita e corrente sul nodo_B_2:
