...
+
Se si dispone di un contratto SupportEdge attivo per link:https://docs.netapp.com/us-en/active-iq/upgrade_advisor_overview.html["Consulente digitale Active IQ"^], Pianificare l'aggiornamento con Upgrade Advisor.  Se non si dispone dell'accesso a Active IQ Digital Advisor, creare un piano di aggiornamento personalizzato.
