...
----
`<location>` Può essere un server Web o una cartella locale, a seconda della versione di ONTAP. Vedere la `system node image update` pagina man per i dettagli.
