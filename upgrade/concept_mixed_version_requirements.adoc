...
---
= Compatibilità della versione di ONTAP per cluster con versioni miste
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
| 9.17.1 | 9.18.1 | Supportato 


.2+| 9.16.1 | 9.18.1 | Supportato 


| 9.17.1 | Supportato 


.3+| 9.15.1 | 9.18.1 | Supportato 
...
.5+| 9.13.1 | 9.18.1 | Non supportato 
...
.5+| 9.12.1 | 9.17.1 o successivo | Non supportato 
...
.5+| 9.11.1 | 9.16.1 o versione successiva  a| 
Non supportato
...
.5+| 9.10.1 | 9.15.1 o versione successiva  a| 
Non supportato
