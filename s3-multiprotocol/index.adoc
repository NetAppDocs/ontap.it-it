...
NOTE: Gli oggetti multipart nei bucket NAS S3 devono essere allineati in dimensioni intere, non parziali. Ad esempio, una parte può essere di 4MB o 4GB o di dimensioni simili. Una parte non può utilizzare dimensioni parziali o inferiori a MB, come 4.5MB o 4000.5MB.
...
* CopyObject non supportato nei volumi SnapLock
