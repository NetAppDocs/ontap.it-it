...
NOTE: Queste azioni di S3 non sono specificamente supportate quando si utilizzano bucket S3 in S3 NAS. Quando si utilizzano bucket S3 nativi, queste azioni sono link:../s3-config/ontap-s3-supported-actions-reference.html["supportato come di consueto"].
