...
---
= Aggiorna e ripristina ONTAP con la sincronizzazione attiva SnapMirror
:allow-uri-read: 
:nofooter: 
:icons: font
:linkattrs: 
...
[role="lead"]
La sincronizzazione attiva di SnapMirror è supportata a partire da ONTAP 9,9.1. L'aggiornamento e il ripristino del cluster ONTAP ha implicazioni per le relazioni di sincronizzazione attiva SnapMirror, a seconda della versione di ONTAP a cui si sta eseguendo l'aggiornamento o il ripristino.
