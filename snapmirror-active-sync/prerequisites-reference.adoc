...
* La sincronizzazione attiva di SnapMirror supporta i cluster ha a due nodi. A partire da ONTAP 9.16.1, la SnapMirror Active Sync supporta anche cluster a quattro nodi.
