...
NOTE: La tecnologia asimmetrica attivo/attivo non supporta ASA r2 e NVMe. Per ulteriori informazioni sul supporto NVMe, vedere link:../nvme/support-limitations.html["Configurazione, supporto e limitazioni NVMe"].
