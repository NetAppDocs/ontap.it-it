...
Nelle configurazioni attive/passive asimmetriche i dati sul sito secondario vengono inoltrati a una LUN, namespace o storage unit.
...
La priorità primaria e il bias primario sono supportati in SnapMirror active sync a partire da ONTAP 9.15.1. Le copie primarie vengono designate in System Manager e visualizzate tramite l'ONTAP REST API e l'ONTAP CLI.
...
* NVMe per carichi di lavoro VMware
 ...
 a| 
* Asimmetrico attivo/passivo



NOTE: L'architettura asimmetrica attiva/passiva non supporta ASA r2 e NVMe. Per ulteriori informazioni sul supporto NVMe, vedere link:../nvme/support-limitations.html["Configurazione, supporto e limitazioni NVMe"].
...
* FC
 ...
 a| 
* Asimmetrico attivo/passivo
* Configurazioni simmetriche attive/attive supportano cluster da 4 a 4 nodi in ONTAP 9.16.1 e versioni successive. Per ASA r2, sono supportati solo cluster da 2 nodi.
...
* FC
 ...
 a| 
* Asimmetrico attivo/passivo
* Le configurazioni attive/attive simmetriche supportano cluster a 2 nodi in ONTAP 9.15.1. I cluster da 2 nodi a 2 nodi e i cluster da 4 nodi a 4 nodi sono supportati in ONTAP 9.16.1 e versioni successive.
