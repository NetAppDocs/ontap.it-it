...
A partire da ONTAP 9.11.1, AIX è supportato con la sincronizzazione attiva SnapMirror tramite PVR standard di progettazione con l'accordo che le seguenti disposizioni sono comprese:
