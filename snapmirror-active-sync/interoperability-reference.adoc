...
A partire da ONTAP 9.19.1 RC, ARP/AI supporta i volumi primari che partecipano a relazioni SAN di sincronizzazione attiva SnapMirror. Per ulteriori informazioni, vedere link:../anti-ransomware/use-cases-restrictions-concept.html#interoperability-and-vm-considerations["Casi di utilizzo e considerazioni sulla protezione ransomware autonoma"].
