...
A partire da ONTAP 9.19.1, ARP/AI supporta i volumi primari che partecipano a relazioni SAN di sincronizzazione attiva SnapMirror. Per ulteriori informazioni, vedere link:../anti-ransomware/support-arpai.html#arp-ai-and-virtual-machines["Casi di utilizzo e considerazioni sulla protezione ransomware autonoma"].
