...
Puoi monitorare lo stato e l'avanzamento di un'operazione di failover pianificata usando il comando  `snapmirror failover show`. Ad esempio, in una configurazione SAN:
