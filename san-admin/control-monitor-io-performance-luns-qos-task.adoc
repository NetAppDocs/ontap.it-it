...
summary: È possibile controllare le prestazioni di input e output delle LUN assegnando le LUN a gruppi di policy QoS di storage. È possibile controllare le prestazioni di input e output per garantire che i carichi di lavoro raggiungano specifici obiettivi di prestazioni o per limitare un carico di lavoro che ha un impatto negativo su altri carichi di lavoro. 
---
