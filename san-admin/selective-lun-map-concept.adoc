...
summary: 'La mappatura selettiva LUN riduce il numero di percorsi dall"host alla LUN. Con SLM, quando viene creata una nuova mappatura LUN, la LUN è accessibile solo tramite percorsi sul nodo proprietario della LUN e sul suo partner HA.' 
---
