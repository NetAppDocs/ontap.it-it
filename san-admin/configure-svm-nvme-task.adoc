...
. Selezionare *Abilita NVMe/FC* o *Abilita NVMe/TCP*.
. Se si abilita NVMe/TCP e si desidera che i percorsi di rete passino automaticamente al partner HA in caso di guasto di un nodo, procedere come segue:
+
