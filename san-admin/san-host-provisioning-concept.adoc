...
summary: Negli ambienti SAN, i sistemi di storage sono target che dispongono di dispositivi di destinazione di storage. Per iSCSI e FC, i dispositivi di destinazione di storage sono denominati LUN. Per Non-Volatile Memory Express over Fibre Channel, i dispositivi di destinazione di storage sono denominati namespace. 
---
