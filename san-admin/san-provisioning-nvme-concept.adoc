...
summary: A partire da ONTAP 9.4, NVMe FC è supportato in ambiente SAN. NVMe FC consente agli amministratori dello storage di effettuare il provisioning di namespace e sottosistemi e quindi di mappare i namespace ai sottosistemi, in modo simile a come vengono effettuati il provisioning e la mappatura delle LUN agli igroup per FC e iSCSI. 
---
...
https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["Report tecnico di NetApp 4684: Implementazione e configurazione di SAN moderne con NVMe/FC"^]
