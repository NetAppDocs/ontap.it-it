...
summary: È possibile utilizzare il protocollo Non-Volatile Memory Express per fornire storage in un ambiente SAN. Il protocollo NVMe è ottimizzato per le prestazioni con lo storage a stato solido. 
---
= Panoramica di NVMe
:allow-uri-read: 
:icons: font
