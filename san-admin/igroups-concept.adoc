...
summary: I gruppi di initiator sono tabelle di WWPN host del protocollo FC o nomi di nodi host iSCSI. È possibile definire gli igroup e mapparli alle LUN per controllare quali initiator hanno accesso alle LUN. 
---
= Scopri di più sugli igroup SAN di ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
