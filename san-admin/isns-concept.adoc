...
summary: 'Il protocollo Internet Storage Name Service consente la discovery automatica e la gestione dei dispositivi iSCSI su una rete di storage TCP/IP. Un server iSNS mantiene le informazioni sui dispositivi iSCSI attivi sulla rete, inclusi i relativi indirizzi IP, i nomi dei nodi iSCSI (IQN) e i gruppi di portale.' 
---
