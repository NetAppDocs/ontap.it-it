...
summary: A partire da ONTAP 9.10.1, è possibile utilizzare System Manager per assegnare o rimuovere policy di Quality of Service su più LUN contemporaneamente. 
---
