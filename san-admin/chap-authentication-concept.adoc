...
summary: 'Il protocollo di autenticazione Challenge Handshake (CHAP) consente la comunicazione autenticata tra initiator iSCSI e target iSCSI. Quando si utilizza l"autenticazione CHAP, è necessario definire nomi utente e password CHAP sia sull"initiator che sul sistema storage.' 
---
