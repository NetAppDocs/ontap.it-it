...
summary: Gli NetApp All-Flash SAN Arrays sono disponibili a partire da ONTAP 9.7. Gli ASA sono soluzioni SAN-only interamente flash basate su piattaforme AFF NetApp collaudate. 
---
...
* link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Report tecnico NetApp 4080: Best practice per le SAN moderne"^]
