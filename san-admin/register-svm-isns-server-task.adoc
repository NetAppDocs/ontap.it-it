...
summary: È possibile utilizzare il comando vserver iscsi isns per configurare la macchina virtuale di storage in modo che si registri con un server iSNS. 
---
