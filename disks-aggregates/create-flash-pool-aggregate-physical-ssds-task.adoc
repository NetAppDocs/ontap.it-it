...
summary: 'È possibile creare un livello locale Flash Pool abilitando la funzionalità su un livello locale esistente composto da gruppi RAID HDD e aggiungendo uno o più gruppi RAID SSD a tale livello locale. In questo modo si ottengono due set di gruppi RAID per quel livello locale: i gruppi RAID SSD, ovvero la cache SSD, e i gruppi RAID HDD.' 
---
