...
I registri di disinfezione dei dischi specificati, che mostrano quanto è stato completato su ciascun disco, vengono scritti in `/mroot/etc/log/sanitization.log`.
