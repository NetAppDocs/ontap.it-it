...
Il numero minimo di HDD che è possibile aggiungere in un'unica procedura è sei. Il numero minimo di SSD che è possibile aggiungere in un'unica procedura è tre. L'aggiunta di un disco singolo potrebbe ridurre le prestazioni.
