...
`Volume Data Footprint`
 a| 
La quantità totale di spazio utilizzata nell'aggregato contenente dai dati di un volume nel file system attivo e lo spazio utilizzato dagli snapshot del volume. Questa riga non include lo spazio riservato.
 a| 
