...
Per ulteriori informazioni sulle `storage aggregate create` opzioni e i requisiti di creazione di aggregati, consultare la link:https://docs.netapp.com/us-en/ontap-cli/storage-aggregate-create.html["Riferimento al comando ONTAP"^].
