...
summary: Il Disk Qualification Package, o DQP, aggiunge il supporto completo per le unità appena qualificate. Prima di aggiornare il firmware o di aggiungere nuovi tipi o dimensioni di unità a un cluster, è necessario aggiornare il DQP. Una best practice è anche aggiornare regolarmente il DQP. 
---
