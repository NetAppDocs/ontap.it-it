...
* `lun delete` ^3^ *` placement rebalance performance config modify` ^7^
...
. Nuovo comando protetto da regole per 9.18.1
. Nuovo comando protetto da regole per 9.19.1
...
* link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=storage+aggregate["aggregato di stoccaggio"^]
