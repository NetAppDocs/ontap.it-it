...
TIP: Se usi MAV con Autonomous Ransomware Protection, definisci un gruppo di approvazione nuovo o esistente responsabile dell'approvazione delle richieste di pausa, disattivazione e cancellazione dei sospetti per la protezione anti-ransomware.
