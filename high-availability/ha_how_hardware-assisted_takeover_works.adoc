...
https://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/Hardware-assisted_(HWassist)_takeover_-_Resolution_guide["Hardware-assisted (HWassist) - Guida alla risoluzione"^]
