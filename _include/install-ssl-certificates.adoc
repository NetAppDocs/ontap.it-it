...
NOTE: `admin_SVM` è l'SVM di amministrazione per il cluster. Negli esempi seguenti, l'SVM di amministrazione si chiama  `cluster1`, quindi  `cluster1` appare sia nel prompt dei comandi (`cluster1::>` sia come valore per  `-vserver`.
