...
summary: Per garantire il successo delle operazioni non interruttive di Hyper-V e SQL Server su SMB, i volumi devono essere creati con stile di sicurezza NTFS. Poiché lo stile di sicurezza del volume root viene applicato per impostazione predefinita ai volumi creati sulla storage virtual machine, lo stile di sicurezza del volume root deve essere impostato su NTFS. 
---
