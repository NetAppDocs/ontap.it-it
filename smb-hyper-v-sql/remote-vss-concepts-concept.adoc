...
summary: È necessario essere a conoscenza di alcuni concetti fondamentali per comprendere come Remote VSS viene utilizzato dai servizi di backup nelle configurazioni Hyper-V su SMB. 
---
= Concetti VSS remoti
:allow-uri-read: 
:icons: font
