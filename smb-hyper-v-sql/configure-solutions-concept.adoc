...
+
Per informazioni sull'utilizzo di SnapManager con configurazioni Hyper-V su SMB, vedere il  https://docs.netapp.com/us-en/snapmanager-hyper-v/index.html["SnapManager for Hyper-V Documentazione"].
