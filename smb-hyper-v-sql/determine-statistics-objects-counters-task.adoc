...
|===
+
Scopri di più su  `statistics catalog object show` E  `statistics catalog counter show` nel link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=statistics+catalog["Riferimento al comando ONTAP"^] .
