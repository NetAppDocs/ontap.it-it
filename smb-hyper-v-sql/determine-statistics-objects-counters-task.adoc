...
|===
+
Ulteriori informazioni su `statistics catalog` nella link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=statistics+catalog["Riferimento al comando ONTAP"^].
