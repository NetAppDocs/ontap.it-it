...
summary: 'Configurare SMB multicanale per fornire connessioni multiple tra ONTAP e client in un"unica sessione SMB per migliorare la velocità di trasmissione e la tolleranza di errore delle configurazioni Hyper-V e SQL server su SMB.' 
---
