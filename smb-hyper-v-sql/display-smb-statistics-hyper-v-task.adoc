...
* link:https://docs.netapp.com/us-en/ontap-cli/statistics-show.html["vengono visualizzate le statistiche"^]
* link:https://docs.netapp.com/us-en/ontap-cli/statistics-start.html["le statistiche iniziano"^]
* link:https://docs.netapp.com/us-en/ontap-cli/statistics-stop.html["le statistiche si interrompono"^]
