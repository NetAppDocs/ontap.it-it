...
* link:https://docs.netapp.com/us-en/ontap-cli-9141/statistics-show.html["vengono visualizzate le statistiche"^]
* link:https://docs.netapp.com/us-en/ontap-cli-9141/statistics-start.html["le statistiche iniziano"^]
* link:https://docs.netapp.com/us-en/ontap-cli-9141/statistics-stop.html["le statistiche si interrompono"^]
