...
summary: 'È necessario creare volumi di dati NTFS sulla storage virtual machine prima di poter configurare condivisioni disponibili in modo continuo per l"utilizzo con Hyper-V o Microsoft SQL Server su application server SMB. Utilizzare il foglio di lavoro di configurazione dei volumi per creare i volumi di dati.' 
---
