...
summary: 'Le funzionalità ONTAP consentono di abilitare operazioni non interruttive per due applicazioni Microsoft tramite il protocollo SMB: Microsoft Hyper-V e Microsoft SQL Server.' 
---
...
Per ulteriori informazioni sulla tecnologia ONTAP e sull'interazione con i servizi esterni, consultare i seguenti Rapporti Tecnici (TR): ** https://www.netapp.com/pdf.html?item=/media/16334-tr-4172pdf.pdf["Report tecnico NetApp 4172: Best practice Microsoft Hyper-V su SMB 3.0 con ONTAP"^]
