...
summary: Ci sono alcuni concetti relativi alle operazioni non disruptive che dovresti comprendere prima di configurare la soluzione Hyper-V o SQL Server su SMB. 
---
