...
summary: È necessario tenere presente determinati requisiti LIF di rete e dati quando si creano configurazioni di SQL Server o Hyper-V su SMB per operazioni non interruttive. 
---
