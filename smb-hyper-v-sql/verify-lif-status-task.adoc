...
summary: Anche se si configurano macchine virtuali di archiviazione con Hyper-V e configurazioni SQL Server su SMB in modo che le LIF siano presenti su ciascun nodo di un cluster, durante le normali operazioni, alcune LIF potrebbero spostarsi su porte di un altro nodo. È necessario verificare lo stato delle LIF e intraprendere le azioni correttive necessarie. 
---
