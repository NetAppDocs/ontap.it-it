...
| System Manager Classic (ONTAP 9.7 e versioni precedenti) | link:https://docs.netapp.com/us-en/ontap-sm-classic/smb-config/index.html["Panoramica della configurazione SMB"^] 
