...
summary: ONTAP supporta tutti i principali standard di settore per i protocolli client, tra cui NFS, SMB, FC, FCoE, iSCSI, NVMe e S3. 
---
= Scopri i protocolli client ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
