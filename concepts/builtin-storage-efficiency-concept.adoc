...
Per le seguenti piattaforme, l'efficienza di archiviazione è abilitata per impostazione predefinita solo sui volumi con thin provisioning esistenti che avevano l'efficienza di archiviazione abilitata prima dell'aggiornamento a ONTAP 9.15.1 o versioni successive. Puoi abilitare l'efficienza di archiviazione sui volumi appena creati utilizzando il metodo ONTAP CLI o ONTAP REST API. I dati migrati tramite spostamento del volume o tecnologia SnapMirror vengono convertiti in compressione inline 32k solo se la compressione era abilitata sulla piattaforma originale.
