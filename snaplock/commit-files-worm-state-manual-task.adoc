...
summary: È possibile eseguire il commit dei file in WORM manualmente o automaticamente. È anche possibile creare file WORM aggiungibili. 
---
= Invia i file a WORM utilizzando ONTAP SnapLock
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
