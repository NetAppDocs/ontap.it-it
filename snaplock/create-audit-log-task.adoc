...
A partire da ONTAP 9.10.1, non sarà più possibile creare un aggregato SnapLock. Devi utilizzare l'opzione -snaplock-type per link:https://docs.netapp.com/us-en/ontap/snaplock/create-snaplock-volume-task.html["Creare esplicitamente un volume SnapLock"] Specificando conformità o impresa come tipo di SnapLock.
