...
. Nel cluster di destinazione, installare la licenza SnapLock, inizializzare il clock di conformità e, se si utilizza una release ONTAP precedente alla 9.10.1, creare un aggregato SnapLock, come descritto in xref:workflow-concept.html[Workflow SnapLock].
