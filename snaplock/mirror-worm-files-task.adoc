...
. Fare clic su image:icon_kabob.gif["alt=Opzioni di menu"] E selezionare *Protect*.
...
. Sul cluster di destinazione, installare la licenza SnapLock, inizializzare ComplianceClock e, se si utilizza una versione di ONTAP precedente alla 9.10.1, creare un aggregato SnapLock.
