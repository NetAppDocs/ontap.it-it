...
summary: 'È possibile utilizzare i comandi di avvio delle impronte digitali del file di volume e di dump delle impronte digitali del file di volume per visualizzare informazioni chiave su file e volumi, tra cui il tipo di file (normale, WORM o appendice WORM), la data di scadenza del volume e così via.' 
---
= Verificare le impostazioni ONTAP SnapLock
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
====
. Visualizzare l'impronta digitale per il file:
+
