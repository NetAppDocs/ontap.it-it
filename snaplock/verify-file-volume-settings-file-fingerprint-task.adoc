...
summary: È possibile utilizzare i comandi volume file fingerprint start e volume file fingerprint dump per visualizzare informazioni chiave su file e volumi, tra cui il tipo di file, la data di scadenza del volume e così via. 
---
