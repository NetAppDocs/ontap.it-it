...
* La licenza SnapLock deve essere installata sul cluster.
+
Per ulteriori informazioni, vedere link:https://docs.netapp.com/us-en/ontap/snaplock/install-license-task.html["Installazione della licenza SnapLock"].

* Il clock di compliance sul cluster deve essere inizializzato.
+
Per ulteriori informazioni, vedere link:https://docs.netapp.com/us-en/ontap/snaplock/initialize-complianceclock-task.html["Inizializzare il Compliance Clock"].
