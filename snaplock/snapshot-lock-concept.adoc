...
* Volumi di origine FlexCache
+
Supportato a partire da ONTAP 9.16.1.

* SnapMirror sincrono
+
A partire da ONTAP 9.19.1, è possibile specificare il tempo di scadenza solo durante la creazione dello snapshot. Non è possibile impostare o estendere il tempo di scadenza degli snapshot esistenti.
