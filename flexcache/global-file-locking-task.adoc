...
[role="lead"]
A partire da ONTAP 9.10.1, è possibile applicare il blocco globale dei file sui volumi FlexCache per impedire la lettura su tutti i file correlati memorizzati nella cache.
