...
NOTE: Per una documentazione più approfondita sulla dualità di FlexCache, vedere link:../s3-multiprotocol/index.html#how-s3-multiprotocol-support-works["Supporto multiprotocollo ONTAP S3"^].
