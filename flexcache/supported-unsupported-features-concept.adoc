...
* A partire da ONTAP 9.8, un volume secondario SnapMirror può essere un volume di origine FlexCache. Il volume secondario di SnapMirror deve essere inattivo senza aggiornamenti SnapMirror attivi, altrimenti la creazione di FlexCache non riesce.
