...
Supportato a partire da ONTAP 9.5.  L'SVM primario di una relazione SVM DR può avere il volume di origine; tuttavia, se la relazione SVM DR viene interrotta, la relazione FlexCache deve essere ricreata con un nuovo volume di origine.
 a| 
No
