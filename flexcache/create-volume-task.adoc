...
A partire da ONTAP 9,5, FlexCache supporta i volumi FlexVol come volumi di origine e i volumi FlexGroup come volumi FlexCache.  A partire da ONTAP 9,7 sia il volume FlexVol che i volumi FlexGroup sono supportati come volumi di origine.

.Prima di iniziare
* È necessario eseguire ONTAP 9,5 o versione successiva
* Se si utilizza ONTAP 9,6 o versione precedente, è necessario link:add-license-task.html["Aggiungere una licenza FlexCache"].
+
Non è richiesta una licenza FlexCache per ONTAP 9,7 o versioni successive.
