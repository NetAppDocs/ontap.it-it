...
+
** *A partire da ONTAP 9.12.1, è possibile selezionare *attiva copie Snapshot (locale)* e scegliere una policy di copia Snapshot invece di utilizzare quella predefinita.
