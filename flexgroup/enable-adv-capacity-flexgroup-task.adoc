...
* Disabilitare SMB Multichannel prima di abilitare il bilanciamento avanzato della capacità. L'utilizzo di SMB Multichannel con il ribilanciamento avanzato della capacità può causare un'elevata latenza. Per ulteriori informazioni, vedere link:https://kb.netapp.com/on-prem/ontap/da/NAS/NAS-Issues/CONTAP-400433["CONTAP-400433: Elevata latenza di lettura/scrittura quando si utilizza FlexGroup Rebalancing/GDD su client con SMB Multichannel abilitato"].
