...
* ONTAP S3
+
Il ribilanciamento delle FlexGroup non è supportato sui volumi FlexGroup di ONTAP S3, che non sono soggetti a squilibri nello stesso modo dei volumi FlexGroup delle NAS.
