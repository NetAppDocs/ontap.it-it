...
| System Manager Classic (ONTAP 9.7 e versioni precedenti) | https://docs.netapp.com/us-en/ontap-sm-classic/nas-multiprotocol-config/index.html["Panoramica della configurazione multiprotocollo SMB e NFS"^] 
