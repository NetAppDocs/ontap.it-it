...
* link:nfs-admin/case-sensitivity-file-directory-multiprotocol-concept.html["Scopri la distinzione tra maiuscole e minuscole nei nomi di file e directory in un ambiente multiprotocollo ONTAP NFS"]
