...
Per ulteriori informazioni su FPolicy nativo, vedere https://docs.netapp.com/us-en/ontap/nas-audit/fpolicy-config-types-concept.html["Tipi di configurazione FPolicy"].
