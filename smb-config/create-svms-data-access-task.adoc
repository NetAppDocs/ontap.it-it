...
.Prima di iniziare
* A partire da ONTAP 9.13.1, è possibile impostare una capacità massima per una VM di storage. È inoltre possibile configurare gli avvisi quando SVM si avvicina a un livello di capacità di soglia. Per ulteriori informazioni, vedere xref:../volumes/manage-svm-capacity.html[Gestire la capacità SVM].
