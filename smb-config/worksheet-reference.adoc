...
`-default-site`
 a| 
Opzionale: a partire da ONTAP 9.13.1, il sito predefinito usato se una LIF non appartiene a un sito e come fallback se il rilevamento del sito del trusted-domain non riesce.
 a| 
