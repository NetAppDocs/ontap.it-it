...
summary: Per ogni tipo di relazione di protezione dei dati SnapMirror, il flusso di lavoro è lo stesso. Si crea un volume di destinazione, si crea una pianificazione delle attività, si specifica una policy, si crea e si inizializza la relazione. 
---
