...
summary: 'Per tutti i tipi di relazione, l"inizializzazione esegue un trasferimento baseline. Crea un"istantanea del volume di origine, quindi trasferisce tale copia e tutti i blocchi di dati a cui fa riferimento al volume di destinazione. In caso contrario, il contenuto del trasferimento dipende dalla policy.' 
---
