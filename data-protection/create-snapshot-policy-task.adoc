...
summary: Una policy di snapshot specifica quando creare gli snapshot, quante copie conservare e come nominarle. Una policy di snapshot può contenere fino a cinque pianificazioni di processi. 
---
