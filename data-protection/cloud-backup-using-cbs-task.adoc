...
Cloud Backup supporta volumi di lettura/scrittura FlexVol e volumi di protezione dei dati (DP). A partire da ONTAP 9.12,1, Cloud Backup supporta FlexGroup Volumes e SnapLock Volumes.
