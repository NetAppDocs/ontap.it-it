...
* È possibile utilizzare SVM DR per migrare un SVM che non soddisfa le restrizioni indicate per link:../svm-migrate/index.html["Migrazione SVM (mobilità dei dati SVM)"].
