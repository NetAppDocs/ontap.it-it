...
* La versione di ONTAP nel cluster di destinazione non deve essere superiore a 2 versioni on-premise più recenti o a due versioni cloud più recenti, come mostrato nella tabella seguente.
