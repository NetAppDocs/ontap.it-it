...
* La replica è supportata in un'unica direzione da una versione precedente di ONTAP a una versione successiva di ONTAP, ad esempio da ONTAP 9.11.1 a ONTAP 9.12.1
