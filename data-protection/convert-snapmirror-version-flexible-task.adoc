...
---
= Convertire una relazione di tipo DP esistente in XDP in ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
Potrebbe essere utile conservare una copia dell'output del[`snapmirror show` comando per tenere traccia delle impostazioni di relazione esistenti. Ulteriori informazioni sul comando link:https://docs.NetApp.com/us-en/ONTAP-cli//SnapMirror-show.html[`snapmirror show`] nel riferimento comandi ONTAP.
...
----
+
Ulteriori informazioni sul comando link:https://docs.NetApp.com/us-en/ONTAP-cli/SnapMirror-quiesce.html[`snapmirror quiesce`] nel riferimento comandi ONTAP.
...
----
+
Ulteriori informazioni sul comando link:https://docs.NetApp.com/us-en/ONTAP-cli/SnapMirror-break.html[`snapmirror-break`^] nel comando ONTAP command reference .
...
----
+
Ulteriori informazioni sul comando link:https://docs.NetApp.com/us-en/ONTAP-cli/SnapMirror-delete.html[`snapmirror-delete`^] nel riferimento comandi ONTAP.
