...
----
+
Per la sintassi completa dei comandi, vedere link:https://docs.netapp.com/us-en/ontap-cli-9141//snapmirror-quiesce.html["pagina man"^].
...
----
+
Per la sintassi completa dei comandi, vedere link:https://docs.netapp.com/us-en/ontap-cli-9141//snapmirror-break.html["pagina man"^].
...
----
+
Per la sintassi completa dei comandi, vedere link:https://docs.netapp.com/us-en/ontap-cli-9141//snapmirror-delete.html["pagina man"^].
