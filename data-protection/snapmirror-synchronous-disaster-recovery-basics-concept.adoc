...
| Protezione autonoma dal ransomware | ONTAP 9.19.1 | Se si abilita ARP sui volumi che fanno parte di relazioni SnapMirror synchronous o SnapMirror active sync dopo l'aggiornamento, la relazione passa brevemente a uno stato non sincronizzato. Questa condizione è temporanea e la relazione dovrebbe risincronizzarsi automaticamente senza alcun intervento. Per ulteriori informazioni, vedere link:../anti-ransomware/use-cases-restrictions-concept.html["Casi di utilizzo e considerazioni sulla protezione ransomware autonoma"]. 
