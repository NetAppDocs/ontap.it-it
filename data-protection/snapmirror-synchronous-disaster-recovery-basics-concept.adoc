...
| Protezione autonoma dal ransomware | ONTAP 9.19.1 | Dopo l'aggiornamento a ONTAP 9.19.1 RC e l'abilitazione di ARP sui volumi che fanno parte di relazioni sincrone SnapMirror, la relazione potrebbe trovarsi brevemente in uno stato di non sincronizzazione. Questa condizione è temporanea e la relazione si risincronizzerà automaticamente senza alcun intervento. 
