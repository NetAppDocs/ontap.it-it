...
| Protezione autonoma dal ransomware | ONTAP 9.19.1 | Dopo l'aggiornamento a ONTAP 9.19.1 RC e l'attivazione di ARP, la relazione potrebbe trovarsi brevemente in uno stato di Out‑of‑Sync. Questa condizione è temporanea e la relazione dovrebbe risincronizzarsi automaticamente senza alcun intervento. 
