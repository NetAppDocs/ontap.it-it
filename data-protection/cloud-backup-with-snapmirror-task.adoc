...
* Il backup cloud SnapMirror supporta relazioni fanout. Ciò significa che i backup SnapMirror possono essere creati simultaneamente su due diversi archivi di oggetti.
