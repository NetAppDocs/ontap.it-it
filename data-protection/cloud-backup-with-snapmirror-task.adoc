...
A partire da ONTAP 9.16.1, il backup su cloud SnapMirror supporta relazioni fanout. Ciò significa che i backup SnapMirror possono essere creati simultaneamente su due diversi archivi di oggetti.
