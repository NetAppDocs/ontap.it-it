...
* link:convert-exclude-svm-replication-task.html["Converti una relazione di replica SVM ONTAP SnapMirror per includere le informazioni di configurazione SVM"]
