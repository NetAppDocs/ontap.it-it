...
+
Se hai acquistato il sistema prima di giugno 2019 con un pacchetto Premium o Flash, puoi scaricare una chiave di licenza NetApp per ottenere la licenza sincrona SnapMirror necessaria dal sito di supporto NetApp: https://mysupport.netapp.com/NOW/knowledge/docs/olio/guides/master_lickey/["chiavi di licenza"^].
