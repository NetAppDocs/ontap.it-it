...
Gli snapshot di conservazione a lungo termine sono disponibili solo per le configurazioni FlexVol SnapMirror . Non è possibile creare snapshot di conservazione a lungo termine per le configurazioni FlexGroup SnapMirror .
