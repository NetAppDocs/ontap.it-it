...
summary: Una policy di snapshot definisce le modalità di creazione degli snapshot da parte del sistema. La policy specifica quando creare gli snapshot, quante copie conservare e come nominarle. 
---
