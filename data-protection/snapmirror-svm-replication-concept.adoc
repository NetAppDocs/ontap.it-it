...
** L'associazione dei volumi con le policy di snapshot definite dall'utente e dal sistema non viene copiata nella SVM di destinazione.
...
Abilita IPsec
 a| 
Non è più supportato a partire da ONTAP 9.19.1.
