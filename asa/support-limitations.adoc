...
NOTE: Queste limitazioni si applicano agli attuali sistemi ASA. Se si dispone di un sistema ASA R2 (ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30 o ASA A20), vedere link:https://docs.netapp.com/us-en/asa-r2/manage-data/storage-limits.html["Limiti di archiviazione del sistema ASA R2"].
