...
IMPORTANT: Se il gruppo di coerenza ha una relazione SM-BC, è necessario utilizzare *Altro* come tag dell'applicazione o del componente.
...
. Modificare il tipo di componente. Il tipo di componente può essere dati, registri o altro. Se si utilizza SM-BC, deve essere "Altro".
