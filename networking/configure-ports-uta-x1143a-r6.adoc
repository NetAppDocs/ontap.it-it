...
summary: 'Per configurare l"adattatore di destinazione unificato, è necessario configurare le due porte adiacenti sullo stesso chip nella stessa modalità di personalità.' 
---
