...
Ulteriori informazioni su `network port ifgrp add-port` nella link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["Riferimento al comando ONTAP"^]. Ulteriori informazioni su `network port ifgrp add-port` nella link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["Riferimento al comando ONTAP"^].
...
Ulteriori informazioni su `network port ifgrp delete` nella link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["Riferimento al comando ONTAP"^]. Ulteriori informazioni su `network port ifgrp delete` nella link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["Riferimento al comando ONTAP"^].
