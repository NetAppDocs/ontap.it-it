...
summary: Utilizza i protocolli di rilevamento dei vicini per visualizzare la connettività di rete tra una coppia di sistemi fisici o virtuali e le relative interfacce di rete. 
---
= Protocolli di rilevamento dei vicini per la connettività di rete ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
