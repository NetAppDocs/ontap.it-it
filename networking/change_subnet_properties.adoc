...
summary: 'Modifica l"indirizzo di sottorete, il valore della maschera, l"indirizzo del gateway o l"intervallo di indirizzi IP.' 
---
= Modifica le proprietà della sottorete ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
