...
|===
Per ulteriori informazioni su `system snmp`, `security`, e. `event` comandi, vedere le pagine man: http://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-cmpr/GUID-5CB10C70-AC11-41C0-8C16-B4D0DF916E9B.html["Comandi di ONTAP 9"^]
