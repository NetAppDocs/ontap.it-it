...
summary: Se una porta viene ricablata o la configurazione dello switch cambia, potrebbe essere necessario riparare la porta e inserirla in un dominio di broadcast diverso, nuovo o esistente. 
---
