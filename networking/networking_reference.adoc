...
Per comprendere l'impatto delle funzionalità di rete disponibili in ogni versione di ONTAP 9, vedere la link:../ontap/release-notes/index.html["Note di rilascio di ONTAP"].
