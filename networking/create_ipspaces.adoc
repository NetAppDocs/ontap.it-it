...
[NOTE]
====
A partire da ONTAP 9.19.1, ONTAP migliora le prestazioni del trasferimento dati TCP su collegamenti WAN con perdita di pacchetti e alta latenza, integrando due funzionalità di recupero delle perdite nello stack TCP di ONTAP: PRR e RACK. link:improve-tcp-wan-performance.html["Scopri come migliorare le prestazioni TCP WAN con PRR e RACK"]
