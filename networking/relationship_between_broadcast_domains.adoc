...
summary: I domini di broadcast, i gruppi di failover e le policy di failover collaborano per determinare quale porta subentrerà in caso di guasto. 
---
= Come funzionano i domini di broadcast, i gruppi di failover e le policy di ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
