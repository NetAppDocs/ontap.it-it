...
summary: Configura SNMP per monitorare le SVM nel tuo cluster. 
---
...
Per ulteriori informazioni sul supporto SNMP nei sistemi ONTAP, vedi  https://www.netapp.com/pdf.html?item=/media/16417-tr-4220.pdf["TR-4220: Supporto SNMP in Data ONTAP"^].
