...
Se la zona di bilanciamento del carico esiste già, la LIF viene aggiunta ad essa. Per ulteriori informazioni sul comando, consultare la link:http://docs.netapp.com/us-en/ontap-cli["Riferimento comandi ONTAP 9"^].
