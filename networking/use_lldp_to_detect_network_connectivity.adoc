...
LLDP deve essere abilitato anche su tutti gli switch e router Ethernet prima che possano essere visualizzate le informazioni sui dispositivi vicini.
...
* Le informazioni visualizzate potrebbero differire tra il cluster e lo switch Ethernet.
+
I dati relativi al Chassis ID e al Port ID visualizzati dallo switch Ethernet potrebbero essere diversi per le porte CNA e non-CNA.
