...
---
= Verificare la configurazione di rete dopo l'aggiornamento a ONTAP 9.8 o versione successiva
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Dopo un aggiornamento a ONTAP 9.8, verificare la configurazione di rete. Dopo l'aggiornamento, ONTAP monitora automaticamente la raggiungibilità di livello 2.

Utilizzare il seguente comando per verificare che ogni porta abbia la raggiungibilità del proprio dominio di trasmissione previsto:
