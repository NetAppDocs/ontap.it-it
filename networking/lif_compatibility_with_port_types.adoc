...
| LIF. VIP | Per LIF VIP si intende qualsiasi LIF di dati creata su una porta VIP. Per ulteriori informazioni, vedere link:../networking/configure_virtual_ip_@vip@_lifs.html["Configurare i LIF VIP (Virtual IP)"]. 
|===