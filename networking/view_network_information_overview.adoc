...
summary: Visualizza e scarica informazioni relative a porte, LIF, route, regole di failover, gruppi di failover, regole firewall, DNS, NIS e connessioni. 
---
= Informazioni di rete che puoi visualizzare in ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
