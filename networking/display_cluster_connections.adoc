...
summary: Visualizza tutte le connessioni attive o in ascolto nel cluster oppure il conteggio delle connessioni attive sul nodo per client, LIF, protocollo o servizio. 
---
...
Scopri di più su `network connections active show-protocols` nella link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=network+connections+active+show-protocols["Riferimento al comando ONTAP"^].
