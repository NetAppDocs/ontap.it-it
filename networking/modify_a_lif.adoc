...
* A partire da ONTAP 9.11.1, la funzionalità di failover LIF iSCSI è disponibile su tutte le piattaforme SAN Array (ASA).
+
Per le LIF iSCSI preesistenti, vale a dire le LIF create prima dell'aggiornamento alla versione 9.11.1 o successiva, è possibile modificare il criterio di failover per attivare la funzione di failover LIF iSCSI.
