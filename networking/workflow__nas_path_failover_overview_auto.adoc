...
---
= Flusso di failover del percorso NAS per ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Un LIF SAN non migra (a meno che non venga spostato manualmente dopo un guasto del collegamento). Invece, la tecnologia multipathing sull'host devia il traffico verso un LIF diverso. Per ulteriori informazioni, vedere link:../san-admin/index.html["Amministrazione SAN"].
