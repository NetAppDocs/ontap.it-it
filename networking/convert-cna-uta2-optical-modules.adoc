...
summary: 'È necessario modificare i moduli ottici sull"adattatore di destinazione unificato per supportare la modalità di personalità selezionata per l"adattatore.' 
---
