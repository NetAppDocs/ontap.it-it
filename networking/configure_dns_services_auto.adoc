...
summary: Configurare i servizi DNS per la SVM prima di creare un server NFS o SMB. 
---
...
NOTE: Per evitare un errore di configurazione di un FQDN SVM non conforme alle regole RFC per gli aggiornamenti DDNS, utilizzare un nome FQDN conforme a RFC. Per ulteriori informazioni, vedere link:https://tools.ietf.org/html/rfc1123["RFC 1123"^].
