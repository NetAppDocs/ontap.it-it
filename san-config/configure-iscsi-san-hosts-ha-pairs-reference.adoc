...
image::../media/scrn-en-drw-iscsi-dual.png[Configurazione della coppia ha multi-network]
...
image::../media/scrn-en-drw-iscsi-single.png[Configurazione coppia ha Singe-network]
...
image::../media/dual-host-dual-controller.png[Configurazione diretta degli allegati]
