...
NOTE: Queste limitazioni si applicano ai sistemi ASA. Se si dispone di un sistema ASA r2 (ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30, ASA A20 o ASA C30), consultare link:https://docs.netapp.com/us-en/asa-r2/manage-data/storage-limits.html["Limiti di archiviazione del sistema ASA R2"^].
...
Per ulteriori informazioni sulle porte persistenti, vedi link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Report tecnico NetApp 4080: Best practice per le SAN moderne"^].
