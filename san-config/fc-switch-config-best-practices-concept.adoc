...
Per le best practice relative a FC e iSCSI, vedi  https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Report tecnico NetApp 4080: Best practice per le SAN moderne"^].
