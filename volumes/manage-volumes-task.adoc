...
* Fare clic su image:icon_delete_with_can_white_bg.gif["icona elimina"] per eliminare i volumi selezionati.
...
Gestire un singolo volume
 a| 
Accanto al volume, fare clic su image:icon_kabob.gif["icona del kebab"], quindi selezionare una delle seguenti azioni da eseguire:
