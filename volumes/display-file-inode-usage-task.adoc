...
summary: Verifica se è necessario aumentare il numero di inode per i tuoi FlexVol volumes per evitare che raggiungano il limite di file. 
---
= Determinare l'utilizzo di file e inode per un volume ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
