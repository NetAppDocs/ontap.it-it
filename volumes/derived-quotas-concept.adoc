...
summary: Una quota imposta a seguito di una quota predefinita, anziché di una quota esplicita, viene definita quota derivata. 
---
= Scopri le quote derivate da ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
