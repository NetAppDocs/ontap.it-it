...
summary: È possibile controllare le prestazioni di input e output dei FlexVol volumi utilizzando i gruppi di criteri QoS di storage per gestire i carichi di lavoro. 
---
= Controlla e monitora le prestazioni I/O del volume FlexVol di ONTAP con Storage QoS
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
