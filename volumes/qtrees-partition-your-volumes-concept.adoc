...
Per ulteriori informazioni sull'API REST di ONTAP, vedere la documentazione relativa all'automazione di ONTAP, incluso https://docs.netapp.com/us-en/ontap-automation/whats-new.html["Novità dell'API REST di ONTAP"^] . Per ulteriori dettagli sugli endpoint dei qtree delle API REST di ONTAP, ti consigliamo di consultare la documentazione diONTAP https://docs.netapp.com/us-en/ontap-automation/reference/api_reference.html["Riferimento API"^].
