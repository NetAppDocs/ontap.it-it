...
summary: 'È possibile spostare un volume FlexVol in un aggregato, nodo o entrambi diversi all"interno della stessa SVM (Storage Virtual Machine) per bilanciare la capacità dello storage dopo aver determinato lo squilibrio della capacità dello storage.' 
---
= Spostare un volume
:allow-uri-read: 
:icons: font
