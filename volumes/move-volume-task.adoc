...
summary: 'Spostare un FlexVol volume in un aggregate, nodo o entrambi diversi all"interno della stessa macchina virtuale di storage per bilanciare la capacità di storage.' 
---
