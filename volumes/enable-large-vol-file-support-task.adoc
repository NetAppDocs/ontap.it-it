...
---
= Abilita il supporto ONTAP per volumi e file di grandi dimensioni
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Se hai abilitato il supporto per volumi e file di grandi dimensioni per un client NFS, il client deve essere rimontato prima che la nuova dimensione massima dei file abbia effetto.
