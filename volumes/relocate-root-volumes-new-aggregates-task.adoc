...
---
= Spostare un volume root ONTAP su nuovi aggregati
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Si verifica un riavvio del nodo durante lo spostamento del volume root, che termina tutte le sessioni SSH attive.
