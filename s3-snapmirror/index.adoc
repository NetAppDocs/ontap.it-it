...
| Cloud Volumes ONTAP per Azure |  | image:status-enabled-perf-config.gif["selezionare"] 
|===
...
* ONTAP versione ONTAP 9.10.1 o successiva deve eseguire cluster di origine e di destinazione.
