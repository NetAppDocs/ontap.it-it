...
summary: 'Quando si creano nuovi bucket S3, è possibile eseguirne immediatamente il backup su un bucket di destinazione S3 SnapMirror su un provider di archivi di oggetti, che può essere un sistema StorageGRID o un"implementazione AWS S3.' 
---
...
[role="lead"]
Quando si creano nuovi bucket S3, è possibile eseguirne immediatamente il backup su un bucket di destinazione S3 SnapMirror su un provider di archivi di oggetti, che può essere un sistema StorageGRID o un'implementazione AWS S3.
