...
summary: È possibile avviare il backup dei bucket S3 esistenti in qualsiasi momento, ad esempio, se si è aggiornata una configurazione S3 da una release precedente a ONTAP 9.10.1. 
---
