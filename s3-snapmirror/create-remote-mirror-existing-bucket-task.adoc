...
Selezionare *Storage > Storage VM,* quindi selezionare la VM di archiviazione, quindi *Settings*. Infine, selezionare image:icon_pencil.gif["icona edit (modifica)"] Sotto *S3*.
+
...
.. Selezionare image:../media/icon_arrow.gif["freccia destra"] Accanto a *Criteri di protezione*, quindi fare clic su *Aggiungi*.
