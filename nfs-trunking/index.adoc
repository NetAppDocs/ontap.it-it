...
summary: A partire da ONTAP 9.14.1, i client NFS che eseguono la versione 4.1 o successiva possono sfruttare la funzionalità di session trunking per aprire più connessioni al server NFS, aumentando così la velocità di trasferimento dei dati e garantendo la resilienza tramite il multipathing. 
---
