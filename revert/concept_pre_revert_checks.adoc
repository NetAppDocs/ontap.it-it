...
| ONTAP 9.18.1  a| 
* Se è stata impostata l'abilitazione automatica per ARP come parte di un aggiornamento ONTAP 9.18.1, sarà necessario link:anti-ransomware-disable-auto-enable.html["disattivarlo"].
