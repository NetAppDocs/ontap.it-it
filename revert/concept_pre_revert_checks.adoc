...
| Il trunking di sessione NFSv4,1 è configurato per ONTAP 9.12.1 o versione successiva? | xref:remove-nfs-trunking-task.html[Rimuovere la configurazione trunking sessione NFSv4,1] 
|===
