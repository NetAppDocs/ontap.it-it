...
summary: Sui cluster nuovi o di test è possibile eseguire il ripristino senza assistenza. È necessario contattare il supporto tecnico per eseguire il ripristino dei cluster di produzione. 
---
