...
summary: 'Prima di ripristinare ONTAP, è necessario verificare l"integrità del cluster, l"integrità dello storage e l"ora di sistema. È inoltre necessario verificare che non siano in esecuzione processi sul cluster.' 
---
...
** Il nodo primario del quorum per anello deve essere lo stesso per tutti i nodi.
+
Nota che ogni anello potrebbe avere un primario di quorum diverso.
