...
[role="lead"]
È possibile ripristinare direttamente il software ONTAP a una sola versione precedente a quella ONTAP .  Ad esempio, se si utilizza la versione 9.15.1, non è possibile tornare direttamente alla versione 9.13.1.  Per prima cosa è necessario ripristinare la versione 9.14.1; quindi eseguire un ripristino separato dalla versione 9.14.1 alla versione 9.13.1.
...
NOTE: link:https://docs.netapp.com/us-en/ontap-afx/administer/revert-ontap.html["Sistemi di stoccaggio AFX"^]non supportano il ripristino del software ONTAP .
