...
+
Per ulteriori informazioni sull'eliminazione delle relazioni di condivisione del carico, vedi link:https://kb.netapp.com/on-prem/ontap/DP/SnapMirror/SnapMirror-KBs/How_to_remove_a_load-sharing_LS_mirror_relationship["Come rimuovere una relazione di mirroring con condivisione del carico"].
