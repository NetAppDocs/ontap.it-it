...
+
Per un elenco completo delle opzioni, consultare la link:https://docs.netapp.com/us-en/ontap-cli-9141/vserver-vscan-on-demand-task-create.html["riferimento al comando"^].
