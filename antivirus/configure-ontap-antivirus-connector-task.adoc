...
Per ulteriori informazioni, consultare link:https://docs.netapp.com/us-en/ontap-cli-9131//security-login-domain-tunnel-create.html["login di sicurezza creazione del tunnel di dominio"] Pagina man di ONTAP.
