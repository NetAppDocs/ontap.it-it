...
Come mostrato nella tabella seguente, i dettagli di interoperabilità per Trellix e Trend Micro sono mantenuti nella NetApp Interoperability Matrix. I dettagli di interoperabilità per Trellix, Deep Instinct e OPSWAT sono disponibili anche sui siti web dei partner. I dettagli di interoperabilità per Sentinel One, Symantec, Deep Instinct, OPSWAT e altri nuovi partner saranno mantenuti dai partner sui rispettivi siti web.
...
* link:https://docs.trellix.com/bundle/endpoint-security-storage-protection-2.3.x-product-guide/page/GUID-58044D4D-91E6-4F1C-892C-605783676063.html["NetApp configuration su Trellix ePO - Endpoint gestiti on-prem (trellix.com)"^]
...
| Trend Micro | link:https://docs.trendmicro.com/en-us/documentation/article/serverprotect-for-netapp-gsg-aspx-__architecture-cluster-2["Architettura del prodotto in Cluster-Mode"^] | link:https://imt.netapp.com/matrix/["Tool di matrice di interoperabilità NetApp"^] 


| Sentinel One  a| 
* link:https://www.sentinelone.com/platform/singularity-cloud-data-security/["SentinelOne Singularity Cloud Data Security"^]
* link:https://www.sentinelone.com/resources/datasheets/threat-detection-for-netapp/["Rilevamento delle minacce per NetApp"^]
