...
summary: 'Dopo aver testato con successo l"accesso del client NFS, è possibile eseguire ulteriori configurazioni NFS o aggiungere l"accesso SAN. Una volta completato l"accesso al protocollo, è necessario proteggere il volume root della storage virtual machine.' 
---
...
* https://www.netapp.com/pdf.html?item=/media/16398-tr-3580.pdf["Report tecnico di NetApp 3580: Guida ai miglioramenti e alle Best practice di NFSv4 per l'implementazione di Data ONTAP"^]
+
...
* https://www.netapp.com/pdf.html?item=/media/16885-tr-4182.pdf["Report tecnico di NetApp 4182: Considerazioni sulla progettazione dello storage Ethernet e Best practice per le configurazioni di Clustered Data ONTAP"^]
+
...
* https://www.netapp.com/pdf.html?item=/media/16328-tr-4668.pdf["Report tecnico di NetApp 4668: Guida alle Best practice per i servizi di nome"^]
+
