...
summary: 'Uno dei metodi che puoi utilizzare per abbinare i client nelle policy di esportazione consiste nell"utilizzare gli host elencati nei netgroup. Puoi caricare i netgroup da un identificatore di risorsa uniforme negli SVM come alternativa all"utilizzo di netgroup memorizzati in server dei nomi esterni.' 
---
