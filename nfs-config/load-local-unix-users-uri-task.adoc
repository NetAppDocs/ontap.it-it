...
summary: 'In alternativa alla creazione manuale di singoli utenti UNIX locali negli SVM, è possibile semplificare l"operazione caricando un elenco di utenti UNIX locali negli SVM da un uniform resource identifier.' 
---
