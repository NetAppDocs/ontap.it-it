...
image::../media/nfs-config-pg-workflow_ieops-1616.png[Viene fornita una panoramica del processo di installazione di NFS,including the steps that occur before NFS setup begins,and the steps that can be optionally performed afterwards.]
