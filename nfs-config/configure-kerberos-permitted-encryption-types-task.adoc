...
summary: 'Per impostazione predefinita, ONTAP supporta i seguenti tipi di crittografia per NFS Kerberos: DES, 3DES, AES-128 e AES-256. È possibile configurare i tipi di crittografia consentiti per ogni SVM in base ai requisiti di sicurezza del proprio ambiente utilizzando il comando vserver nfs modify con il parametro -permitted-enc-types.' 
---
