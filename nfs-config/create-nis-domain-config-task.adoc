...
summary: 'Se nel tuo ambiente viene utilizzato un Network Information Service per i servizi di denominazione, devi creare una configurazione di dominio NIS per l"SVM utilizzando il comando vserver services name-service nis-domain create.' 
---
