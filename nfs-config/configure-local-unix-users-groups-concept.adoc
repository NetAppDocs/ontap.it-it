...
summary: 'È possibile utilizzare utenti e gruppi UNIX locali sull"SVM per l"autenticazione e la mappatura dei nomi. È possibile creare utenti e gruppi UNIX manualmente oppure caricare un file contenente utenti o gruppi UNIX da un uniform resource identifier.' 
---
