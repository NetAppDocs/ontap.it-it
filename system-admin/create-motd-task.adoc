...
summary: È possibile creare un messaggio del giorno per comunicare informazioni agli utenti CLI autenticati. Il messaggio del giorno viene visualizzato in una sessione console o in una sessione SSH dopo che un utente è stato autenticato, ma prima che appaia il prompt di clustershell. 
---
