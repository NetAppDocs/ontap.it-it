...
+
** link:https://docs.netapp.com/us-en/ontap-systems/aff-aseries/index.html["Sistemi AFF serie A"^]
** link:https://docs.netapp.com/us-en/ontap-systems/aff-cseries/index.html["Sistemi AFF serie C"^]
...
[NOTE]
====
Per ulteriori informazioni sulla configurazione di un cluster tramite l'interfaccia grafica di configurazione, consultare la link:../task_admin_add_nodes_to_cluster.html["documentazione sulla gestione dei nodi"]. Per saperne di più su  `cluster setup` nella link:https://docs.netapp.com/us-en/ontap-cli/cluster-setup.html["Riferimento al comando ONTAP"^].
