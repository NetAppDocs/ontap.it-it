...
summary: 'Se preferisci utilizzare un"interfaccia grafica anziché l"interfaccia a riga di comando per accedere e gestire un cluster, puoi farlo tramite System Manager, incluso in ONTAP come servizio web, abilitato per impostazione predefinita e accessibile tramite browser.' 
---
