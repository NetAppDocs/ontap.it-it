...
+
Il `-application` parametro dei[`security login` comandi specifica il metodo di accesso per un account utente. Ulteriori informazioni sul comando link:https://docs.NetApp.com/us-en/ONTAP-cli/Security-login-create.html#description[`security login`] nel riferimento comandi ONTAP.
