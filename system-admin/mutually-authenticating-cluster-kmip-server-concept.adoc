...
summary: 'L"autenticazione reciproca tra il cluster e un gestore di chiavi esterno, come un server Key Management Interoperability Protocol, consente al gestore di chiavi di comunicare con il cluster utilizzando KMIP su SSL. Questa procedura è necessaria quando un"applicazione o una determinata funzionalità richiede chiavi sicure per garantire un accesso protetto ai dati.' 
---
