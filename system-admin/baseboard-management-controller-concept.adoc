...
summary: Su alcune piattaforme hardware, il software viene personalizzato per supportare un nuovo controller integrato chiamato Baseboard Management Controller. Il BMC dispone di comandi a riga di comando che è possibile utilizzare per gestire il dispositivo da remoto. 
---
