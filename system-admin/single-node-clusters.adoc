...
summary: 'Un cluster a nodo singolo è un"implementazione particolare di un cluster che viene eseguito su un nodo autonomo. I cluster a nodo singolo non sono raccomandati perché non offrono ridondanza. Se il nodo si arresta, l"accesso ai dati viene perso.' 
---
...
https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["Report tecnico NetApp 4684: Implementazione e configurazione di SAN moderne con NVMe-of"^]
