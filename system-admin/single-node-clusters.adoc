...
image::../media/r-oc-set-iscsi-singlenetwork-singlenode.png[Configurazione a nodo singolo di rete direct-attached]
...
image::../media/scrn-en-drw-iscsi-multinw-singlen.png[Configurazione multi-network a nodo singolo]
