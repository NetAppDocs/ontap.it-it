...
summary: 'La configurazione dell"accesso ai servizi web consente agli utenti autorizzati di utilizzare HTTP o HTTPS per accedere al contenuto del servizio sul cluster o su una storage virtual machine.' 
---
