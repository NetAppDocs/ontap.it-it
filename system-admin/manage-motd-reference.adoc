...
Per un elenco delle sequenze di escape che possono essere utilizzate per generare dinamicamente il contenuto per il MOTD, vedere link:https://docs.netapp.com/us-en/ontap-cli//security-login-motd-modify.html#parameters["riferimento al comando"].
