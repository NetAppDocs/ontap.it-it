...
summary: 'È possibile visualizzare l"identificativo univoco di un cluster, il nome, il numero di serie, la posizione e le informazioni di contatto di un cluster.' 
---
