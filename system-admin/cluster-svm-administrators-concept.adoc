...
summary: 'Gli amministratori del cluster gestiscono l"intero cluster e le storage virtual machine in esso contenute. Gli amministratori SVM gestiscono solo le proprie SVM di dati.' 
---
