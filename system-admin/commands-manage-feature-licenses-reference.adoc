...
* link:https://kb.netapp.com/onprem/ontap/os/ONTAP_9.10.1_and_later_licensing_overview["NetApp Knowledge Base: panoramica delle licenze ONTAP 9.10.1 e versioni successive"^]
