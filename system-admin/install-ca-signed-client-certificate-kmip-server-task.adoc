...
summary: 'Il sottotipo di certificato del Key Management Interoperability Protocol, insieme ai tipi client e server-ca, specifica che il certificato viene utilizzato per l"autenticazione reciproca del cluster e di un gestore di chiavi esterno, come un server KMIP.' 
---
