...
summary: Gli avvisi relativi allo stato di salute del sistema attivano AutoSupport messaggi ed eventi nel sistema di gestione degli eventi, consentendo di monitorare lo stato di salute del sistema tramite AutoSupport messaggi e EMS, oltre che utilizzando direttamente il sistema di monitoraggio dello stato di salute. 
---
