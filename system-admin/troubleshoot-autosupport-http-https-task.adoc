...
summary: Se il sistema non invia il messaggio AutoSupport previsto e si sta utilizzando HTTP o HTTPS, è possibile verificare diverse impostazioni per risolvere il problema. 
---
...
+
Per assistenza nella risoluzione di eventuali errori restituiti, consultare link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Software/ONTAP_OS/ONTAP_AutoSupport_(Transport_HTTPS_and_HTTP)_Resolution_Guide["Guida alla risoluzione di ONTAP AutoSupport (Transport HTTPS and HTTP)"^].
