...
summary: Una licenza è un record di uno o più diritti software. A partire da ONTAP 9.10.1, tutte le licenze vengono fornite come NetApp license file, ovvero un singolo file che abilita più funzionalità. A partire da maggio 2023, tutti i sistemi AFF e FAS vengono venduti con la suite software ONTAP One o con la suite software ONTAP Base, e a partire da giugno 2023, tutti i sistemi ASA vengono venduti con ONTAP One per SAN. 
---
...
ONTAP One contiene tutte le funzionalità con licenza disponibili. Contiene una combinazione dei contenuti dei precedenti bundle Core, Data Protection, Security and Compliance, Hybrid Cloud ed Encryption. La crittografia non è disponibile nei paesi soggetti a restrizioni.
...
A partire da giugno 2023, i sistemi ONTAP che utilizzano chiavi di licenza a 28 caratteri possono anche link:https://kb.netapp.com/onprem/ontap/os/How_to_get_an_ONTAP_One_license_when_the_system_has_28_character_keys["Eseguire l'aggiornamento al bundle di compatibilità ONTAP One o ONTAP base"^].
