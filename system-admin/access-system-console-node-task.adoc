...
summary: 'Se un nodo si blocca nel menu di boot o nel prompt dell"ambiente di boot, è possibile accedervi solo tramite la console di sistema. È possibile accedere alla console di sistema di un nodo tramite una connessione SSH allo SP o al cluster.' 
---
