...
summary: 'È possibile utilizzare il comando `security certificate generate-csr` per generare una richiesta di firma del certificato. Dopo aver elaborato la richiesta, l"autorità di certificazione invia il certificato digitale firmato.' 
---
