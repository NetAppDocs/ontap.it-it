...
summary: È possibile abilitare o disabilitare un servizio web per il cluster o per una macchina virtuale di storage, visualizzare le impostazioni dei servizi web e controllare se gli utenti di un ruolo possono accedere a un servizio web. 
---
