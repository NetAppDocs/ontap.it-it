...
summary: 'È possibile visualizzare manualmente gli avvisi sullo stato di salute del sistema utilizzando il comando `system health alert show`. Tuttavia, è consigliabile iscriversi a specifici messaggi del sistema di gestione eventi per ricevere automaticamente le notifiche quando un health monitor genera un avviso.' 
---
