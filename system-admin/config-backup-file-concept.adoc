...
summary: I file di backup della configurazione sono file di archivio che contengono informazioni per tutte le opzioni configurabili necessarie affinché il cluster e i nodi al suo interno funzionino correttamente. 
---
