...
summary: ONTAP consente di configurare un banner di accesso o un messaggio del giorno per comunicare informazioni amministrative a System Manager e agli utenti della CLI del cluster o della storage virtual machine. 
---
