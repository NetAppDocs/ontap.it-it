...
summary: Il servizio web Service Processor Infrastructure è abilitato per impostazione predefinita per consentire a un browser web di accedere ai file di log, core dump e MIB di un nodo del cluster. I file rimangono accessibili anche quando il nodo è inattivo, a condizione che il nodo venga assunto dal suo partner. 
---
