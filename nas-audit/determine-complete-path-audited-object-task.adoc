...
summary: 'Il percorso dell"oggetto stampato nel tag ObjectName di un record di audit contiene il nome del volume tra parentesi e il percorso relativo dalla radice del volume contenitore. Se si desidera determinare il percorso completo dell"oggetto sottoposto ad audit, incluso il percorso di giunzione, è necessario seguire alcuni passaggi.' 
---
