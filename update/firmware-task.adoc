...
summary: È possibile applicare un aggiornamento del firmware ai dispositivi supportati nel cluster, come dischi, shelf di dischi, service processor o Baseboard Management Controller. 
---
...
[role="lead"]
A partire da ONTAP 9.9.1, se si è registrati con link:https://docs.netapp.com/us-en/active-iq/["Consulente digitale"^], è possibile ricevere avvisi in System Manager che informano quando aggiornamenti del firmware per dispositivi supportati, come dischi, shelf di dischi, service processor (SP) o Baseboard Management Controller (BMC), sono in sospeso sul cluster.

Se utilizzi ONTAP 9.8 o non sei registrato a Digital Advisor, vai al NetApp Support Site per scaricare gli aggiornamenti del firmware.
...
.Fasi
Segui la procedura appropriata in base alla tua versione di ONTAP e se sei registrato/a con Digital Advisor.
