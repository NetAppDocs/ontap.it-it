...
. Nella sezione *Impostazioni di aggiornamento automatico*, selezionare l'azione da intraprendere per ciascun tipo di aggiornamento.
+
*Aggiorna automaticamente* è selezionato per tutte le opzioni per impostazione predefinita. Puoi scegliere di modificare la selezione predefinita in *Mostra notifiche* o *Ignora automaticamente gli aggiornamenti*.

. Seleziona *Accetto per gli aggiornamenti attuali e futuri* e poi seleziona *Salva*.
...
--
. In System Manager, selezionare *Cluster > Settings*.
. Nella sezione *Aggiornamenti automatici*, selezionare image:icon_kabob.gif["selezione del menu"] e quindi selezionare *Abilita*.
+
*Aggiorna automaticamente* è selezionato per tutte le opzioni per impostazione predefinita. Puoi scegliere di modificare la selezione predefinita in *Mostra notifiche* o *Ignora automaticamente gli aggiornamenti*.
