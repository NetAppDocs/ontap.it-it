...
summary: 'È possibile eliminare gli account utente locali dalla macchina virtuale di storage se non sono più necessari per l"autenticazione SMB locale al server CIFS o per determinare i diritti di accesso ai dati contenuti sulla SVM.' 
---
