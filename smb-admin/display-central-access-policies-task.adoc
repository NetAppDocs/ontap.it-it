...
summary: È possibile visualizzare informazioni dettagliate sulle policy di accesso centralizzate definite in Active Directory. È inoltre possibile visualizzare informazioni sulle policy di accesso centralizzate applicate al server CIFS tramite oggetti Criteri di gruppo. 
---
