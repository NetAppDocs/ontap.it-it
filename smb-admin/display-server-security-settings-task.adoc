...
summary: È possibile visualizzare informazioni sulle impostazioni di sicurezza del server SMB sulle macchine virtuali di archiviazione. È possibile utilizzare queste informazioni per verificare che le impostazioni di sicurezza siano corrette. 
---
