...
---
= Abilita BranchCache sulle nuove condivisioni SMB
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Fase
. Crea una condivisione SMB abilitata BranchCache:
+
[source, cli]
----
vserver cifs share create -vserver <SVM_name> -share-name <share_name> -path <path> -share-properties branchcache[,...]
----
. Verificare che la proprietà di condivisione BranchCache sia impostata sulla condivisione SMB:
+
[source, cli]
----
