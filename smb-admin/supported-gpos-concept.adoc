...
summary: Sebbene non tutti gli oggetti Criteri di gruppo siano applicabili alle storage virtual machine abilitate per CIFS, le SVM possono riconoscere ed elaborare il set pertinente di GPO. 
---
