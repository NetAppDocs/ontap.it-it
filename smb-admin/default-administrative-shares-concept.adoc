...
summary: Quando si crea un server CIFS sulla macchina virtuale di storage, vengono create automaticamente delle condivisioni amministrative predefinite. È importante comprendere quali siano queste condivisioni predefinite e come vengano utilizzate. 
---
