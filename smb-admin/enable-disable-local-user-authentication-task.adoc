...
summary: 'È possibile abilitare o disabilitare l"autenticazione utente locale per l"accesso SMB alle storage virtual machines. L"impostazione predefinita è consentire l"autenticazione utente locale, utile quando la SVM non riesce a contattare un domain controller o se si sceglie di non utilizzare i controlli di accesso a livello di dominio.' 
---
