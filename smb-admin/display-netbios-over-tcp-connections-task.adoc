...
summary: È possibile visualizzare informazioni su NetBIOS tramite connessioni TCP. Ciò può essere utile per la risoluzione dei problemi relativi a NetBIOS. 
---
