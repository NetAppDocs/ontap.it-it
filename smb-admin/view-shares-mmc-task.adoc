...
summary: 'È possibile visualizzare informazioni sulle condivisioni SMB sul proprio SVM ed eseguire alcune attività di gestione tramite la Microsoft Management Console. Prima di poter visualizzare le condivisioni, è necessario connettere la MMC all"SVM.' 
---
