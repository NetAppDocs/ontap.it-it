...
summary: Gli oplock consentono ai client di bloccare i file e di memorizzare nella cache i contenuti localmente, il che può aumentare le prestazioni delle operazioni sui file. Gli oplock sono abilitati sulle condivisioni SMB residenti su macchine virtuali di storage. In alcune circostanze, potresti voler disabilitare gli oplock. Puoi abilitare o disabilitare gli oplock per ogni singola condivisione. 
---
