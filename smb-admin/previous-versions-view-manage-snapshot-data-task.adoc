...
summary: 'Gli utenti di computer client Windows possono utilizzare la scheda Versioni precedenti nella finestra Proprietà di Windows per ripristinare i dati archiviati negli snapshot senza dover coinvolgere l"amministratore della storage virtual machine.' 
---
