...
summary: È possibile eliminare un gruppo locale dalla storage virtual machine se non è più necessario per determinare i diritti di accesso ai dati associati a tale SVM o se non è più necessario per assegnare i diritti utente della SVM ai membri del gruppo. 
---
