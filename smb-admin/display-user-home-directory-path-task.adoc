...
summary: 'È possibile visualizzare il percorso home directory dell"utente SMB sulla macchina virtuale di storage, il che può essere utile se sono configurati più percorsi home directory CIFS e si desidera vedere quale percorso contiene la home directory dell"utente.' 
---
