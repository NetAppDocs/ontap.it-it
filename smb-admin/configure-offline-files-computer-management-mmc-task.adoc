...
summary: 'Se si desidera consentire agli utenti di memorizzare i file nella cache locale per l"utilizzo offline, è possibile configurare il supporto per i file offline tramite la console MMC Gestione computer.' 
---
