...
summary: È possibile visualizzare informazioni sul tipo di utenti connessi tramite sessioni SMB. Questo può aiutare a garantire che solo il tipo di utente appropriato si connetta tramite sessioni SMB sulla storage virtual machine. 
---
