...
summary: È possibile impostare gli stili di sicurezza su FlexVol volumes e qtrees. Gli stili di sicurezza possono essere impostati manualmente al momento della creazione, ereditati automaticamente o modificati in un secondo momento. 
---
