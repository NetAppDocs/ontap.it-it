...
summary: È possibile abilitare e configurare i server SMB sulle macchine virtuali di storage per consentire ai client SMB di accedere ai file nel cluster. 
---
