...
summary: Se in precedenza hai configurato BranchCache ma non desideri che la macchina virtuale di storage continui a fornire contenuti memorizzati nella cache, puoi eliminare la configurazione di BranchCache sul server CIFS. Devi essere consapevole di cosa accade quando elimini la configurazione. 
---
