...
summary: Per una sicurezza ottimale con le comunicazioni basate su Kerberos, è possibile abilitare la crittografia AES-256 e AES-128 sul server SMB. Per impostazione predefinita, quando si crea un server SMB sulla SVM, la crittografia Advanced Encryption Standard è disabilitata. È necessario abilitarla per sfruttare la forte sicurezza offerta dalla crittografia AES. 
---
