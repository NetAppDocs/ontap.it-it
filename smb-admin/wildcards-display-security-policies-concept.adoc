...
summary: È possibile utilizzare il carattere jolly per visualizzare informazioni sulla sicurezza dei file e sulle politiche di controllo di tutti i file e le directory presenti in un determinato percorso o in un volume root. 
---
