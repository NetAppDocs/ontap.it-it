...
summary: Se la configurazione di BranchCache abilita automaticamente la memorizzazione nella cache per tutte le condivisioni SMB su ciascuna macchina virtuale di storage, puoi modificare la configurazione di BranchCache per interrompere la memorizzazione automatica nella cache dei contenuti per tutte le condivisioni SMB. 
---
