...
summary: È possibile creare una configurazione della home directory utilizzando il nome utente di Windows e le variabili della home directory. Gli utenti possono quindi connettersi alla propria home directory utilizzando condivisioni create dinamicamente. 
---
