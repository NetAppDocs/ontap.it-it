...
summary: 'Prima di creare un SVM configurato come destinazione per il disaster recovery in cui l"identità non viene conservata, è necessario conoscere le modalità di gestione delle impostazioni di sicurezza del server SMB sull"SVM di destinazione.' 
---
