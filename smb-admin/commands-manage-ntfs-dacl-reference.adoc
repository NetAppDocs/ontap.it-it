...
summary: Esistono comandi ONTAP specifici per la gestione delle voci di controllo degli accessi DACL. È possibile aggiungere ACE alle DACL NTFS in qualsiasi momento. È inoltre possibile gestire le DACL NTFS esistenti modificando, eliminando e visualizzando le informazioni sugli ACE nelle DACL. 
---
