...
summary: È possibile modificare la chiave del server BranchCache modificando la configurazione BranchCache sulla macchina virtuale di storage e specificando una chiave del server diversa. 
---
