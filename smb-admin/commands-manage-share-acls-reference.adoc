...
summary: 'È necessario conoscere i comandi per la gestione degli elenchi di controllo degli accessi SMB, che includono la creazione, la visualizzazione, la modifica e l"eliminazione degli stessi.' 
---
