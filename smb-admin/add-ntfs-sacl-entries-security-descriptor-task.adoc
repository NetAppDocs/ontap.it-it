...
summary: 'L"aggiunta di voci di controllo degli accessi SACL al descrittore di sicurezza NTFS è il secondo passaggio nella creazione di policy di audit NTFS per file o cartelle negli SVM. Ogni voce identifica l"utente o il gruppo che si desidera sottoporre ad audit. La voce SACL definisce se si desidera sottoporre ad audit i tentativi di accesso riusciti o non riusciti.' 
---
