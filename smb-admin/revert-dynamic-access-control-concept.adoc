...
summary: È importante essere consapevoli di cosa accade quando si ripristina una versione di ONTAP che non supporta il Dynamic Access Control e di cosa è necessario fare prima e dopo il ripristino. 
---
