...
summary: 'La firma SMB contribuisce a garantire che il traffico di rete tra il server SMB e il client non venga compromesso. Lo fa prevenendo gli attacchi di replay. Per impostazione predefinita, ONTAP supporta la firma SMB quando richiesta dal client. Facoltativamente, l"amministratore dello storage può configurare il server SMB in modo che richieda la firma SMB.' 
---
