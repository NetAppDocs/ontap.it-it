...
summary: 'È possibile visualizzare informazioni sulle configurazioni degli oggetti Criteri di gruppo (GPO) definiti in Active Directory e sulle configurazioni GPO applicate al server CIFS.' 
---
