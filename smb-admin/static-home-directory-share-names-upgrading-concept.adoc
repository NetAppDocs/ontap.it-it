...
summary: 'I nomi delle condivisioni della home directory devono contenere il nome utente Windows o la variabile dinamica del nome utente UNIX. È importante essere consapevoli di cosa accade ai nomi delle condivisioni statiche della home directory esistenti dopo l"aggiornamento a una versione di ONTAP con il nuovo requisito.' 
---
