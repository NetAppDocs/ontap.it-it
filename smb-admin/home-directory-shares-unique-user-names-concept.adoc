...
summary: Assicurati di assegnare nomi utente univoci quando crei condivisioni di home directory utilizzando le variabili del nome utente di Windows o del nome utente UNIX per generare condivisioni in modo dinamico. Il nome della condivisione viene mappato al tuo nome utente. 
---
