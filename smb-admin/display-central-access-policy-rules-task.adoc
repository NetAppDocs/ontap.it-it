...
summary: È possibile visualizzare informazioni dettagliate sulle regole delle policy di accesso centralizzato associate alle policy di accesso centralizzato definite in Active Directory. È inoltre possibile visualizzare informazioni sulle regole delle policy di accesso centralizzato applicate al server CIFS tramite GPO delle policy di accesso centralizzato. 
---
