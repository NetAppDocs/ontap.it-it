...
summary: È possibile visualizzare informazioni sulle configurazioni BranchCache delle macchine virtuali di archiviazione, che possono essere utilizzate per verificare una configurazione o per determinare le impostazioni correnti prima di modificarla. 
---
