...
summary: 'È possibile abilitare o disabilitare l"enumerazione basata sull"accesso per le condivisioni SMB per consentire o impedire agli utenti di visualizzare le risorse condivise per le quali non dispongono delle autorizzazioni di accesso.' 
---
