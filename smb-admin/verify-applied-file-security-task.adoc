...
summary: È possibile verificare le impostazioni di sicurezza dei file per confermare che i file o le cartelle sulla storage virtual machine a cui è stata applicata la policy di sicurezza abbiano le impostazioni desiderate. 
---
