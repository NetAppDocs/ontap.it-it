...
summary: 'È possibile verificare le impostazioni di sicurezza del file per confermare che i file o le cartelle sulla macchina virtuale di storage (SVM) a cui è stato applicato il criterio di protezione abbiano le impostazioni desiderate.' 
---
= Verificare la sicurezza del file SMB ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Fase
. Visualizzare le impostazioni di sicurezza di file e cartelle: `vserver security file-directory show -vserver vserver_name -path path [-expand-mask true]`
+
