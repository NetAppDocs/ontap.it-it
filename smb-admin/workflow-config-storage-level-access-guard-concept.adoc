...
summary: 'Il flusso di lavoro per configurare Storage-Level Access Guard utilizza gli stessi comandi CLI di ONTAP che si usano per configurare le autorizzazioni dei file NTFS e i criteri di auditing. Invece di configurare l"accesso a file e directory su una destinazione designata, si configura SLAG sul volume della storage virtual machine designata.' 
---
