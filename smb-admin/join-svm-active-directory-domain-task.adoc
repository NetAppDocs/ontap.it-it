...
summary: È possibile aggiungere una macchina virtuale di storage a un dominio Active Directory senza eliminare il server SMB esistente, modificando il dominio tramite il comando vserver cifs modify. È possibile rientrare nel dominio corrente o unirsi a uno nuovo. 
---
