...
summary: È possibile visualizzare un elenco di tutti i gruppi locali configurati sul cluster o su una specifica macchina virtuale di storage. Queste informazioni possono essere utili per la risoluzione dei problemi di accesso ai file contenuti sulla SVM o per i problemi relativi ai diritti utente sulla SVM. 
---
