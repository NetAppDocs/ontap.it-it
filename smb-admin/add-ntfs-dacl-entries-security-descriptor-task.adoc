...
summary: 'L"aggiunta di voci di controllo degli accessi DACL al descrittore di sicurezza NTFS è il secondo passaggio nella configurazione e nell"applicazione degli ACL NTFS a un file o a una cartella. Ogni voce identifica l"oggetto a cui è consentito o negato l"accesso e definisce cosa l"oggetto può o non può fare ai file o alle cartelle definiti nell"ACE.' 
---
