...
summary: Esistono comandi ONTAP specifici per la gestione delle voci di controllo degli accessi SACL. È possibile aggiungere ACE alle SACL NTFS in qualsiasi momento. È inoltre possibile gestire le SACL NTFS esistenti modificando, eliminando e visualizzando le informazioni sugli ACE presenti nelle SACL. 
---
