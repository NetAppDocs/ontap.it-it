...
summary: Tramite la CLI è possibile gestire la sicurezza dei file NTFS, le policy di audit NTFS e Storage-Level Access Guard sulle storage virtual machine. 
---
