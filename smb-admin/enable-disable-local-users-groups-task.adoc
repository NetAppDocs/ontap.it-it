...
summary: 'È possibile abilitare o disabilitare utenti e gruppi locali per l"accesso SMB alle macchine virtuali di archiviazione. La funzionalità di utenti e gruppi locali è abilitata per impostazione predefinita.' 
---
