...
summary: È possibile verificare la policy di audit per confermare che i file o le cartelle sulla storage virtual machine a cui è stata applicata la policy di sicurezza abbiano le impostazioni di sicurezza di audit desiderate. 
---
