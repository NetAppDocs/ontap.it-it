...
summary: 'Per impostazione predefinita, ONTAP recupera e applica le modifiche agli oggetti Criteri di gruppo (GPO) ogni 90 minuti. Le impostazioni di sicurezza vengono aggiornate ogni 16 ore. Se si desidera aggiornare i GPO per applicare le nuove impostazioni dei criteri prima che ONTAP li aggiorni automaticamente, è possibile avviare un aggiornamento manuale su un server CIFS con un comando ONTAP.' 
---
