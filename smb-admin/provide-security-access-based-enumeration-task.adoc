...
summary: 'Quando l"enumerazione basata sugli accessi è abilitata su una condivisione SMB, gli utenti che non dispongono delle autorizzazioni per accedere a una cartella o a un file contenuti nella condivisione non visualizzano tale risorsa condivisa nel proprio ambiente.' 
---
