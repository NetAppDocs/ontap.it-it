...
summary: Configurare le autorizzazioni di condivisione creando elenchi di controllo degli accessi per le condivisioni SMB consente di controllare il livello di accesso a una condivisione per utenti e gruppi. 
---
