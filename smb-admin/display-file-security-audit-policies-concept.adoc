...
summary: È possibile visualizzare informazioni sulla sicurezza dei file e delle directory contenuti nei volumi delle macchine virtuali di storage. È possibile visualizzare informazioni sulle policy di audit sui volumi FlexVol. Se configurato, è possibile visualizzare informazioni sulle impostazioni di sicurezza di Storage-Level Access Guard e Dynamic Access Control sui volumi FlexVol. 
---
