...
summary: Se non si desidera che un utente attraversi tutte le directory nel percorso di un file perché non dispone delle autorizzazioni sulla directory attraversata, è possibile rimuovere il privilegio SeChangeNotifyPrivilege dagli utenti o dai gruppi SMB locali sulle storage virtual machines. 
---
