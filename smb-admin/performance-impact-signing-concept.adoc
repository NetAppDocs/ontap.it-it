...
summary: Quando le sessioni SMB utilizzano la firma SMB, tutte le comunicazioni SMB da e verso i client Windows subiscono un impatto sulle prestazioni, che si ripercuote sia sui client che sul server. 
---
