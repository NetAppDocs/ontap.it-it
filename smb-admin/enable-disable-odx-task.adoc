...
summary: 'È possibile abilitare o disabilitare ODX sulle macchine virtuali di storage. Per impostazione predefinita, il supporto per l"offload di copia ODX è abilitato se è abilitato anche SMB 3.0.' 
---
