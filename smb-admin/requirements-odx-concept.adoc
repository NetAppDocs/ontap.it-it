...
summary: Prima di poter utilizzare ODX per il trasferimento di copie con la storage virtual machine, è necessario essere a conoscenza di alcuni requisiti. 
---
