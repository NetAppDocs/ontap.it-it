...
summary: 'È possibile abilitare o disabilitare l"enumerazione basata sull"accesso per le condivisioni SMB da un client Windows, consentendo di configurare questa impostazione di condivisione senza dover connettersi al server CIFS.' 
---
