...
summary: Se si desidera utilizzare il Controllo dinamico degli accessi sul server CIFS, è necessario comprendere come ONTAP supporta la funzionalità Dynamic Access Control negli ambienti Active Directory. 
---
