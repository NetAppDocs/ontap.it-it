...
summary: Per impostazione predefinita, gli oplock sono abilitati sulle condivisioni SMB delle storage virtual machine. In alcune circostanze, potresti voler disabilitare gli oplock. In alternativa, se in precedenza hai disabilitato gli oplock su una condivisione, potresti volerli riabilitare. 
---
