...
summary: 'Per impostazione predefinita, un utente anonimo e non autenticato può accedere a determinate informazioni sulla rete. È possibile utilizzare un"opzione del server SMB per configurare le restrizioni di accesso per l"utente anonimo.' 
---
