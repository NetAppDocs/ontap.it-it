...
summary: 'È possibile abilitare o disabilitare le policy di esportazione per l"accesso SMB alle storage virtual machine. L"utilizzo delle policy di esportazione per controllare l"accesso SMB alle risorse è facoltativo.' 
---
