...
summary: 'Microsoft Offloaded Data Transfer, noto anche come copy offload, consente trasferimenti diretti di dati all"interno o tra dispositivi storage compatibili senza trasferire i dati attraverso il computer host.' 
---
