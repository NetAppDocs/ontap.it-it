...
link:tiering-policies-concept.html#what-happens-when-you-modify-a-volume-tiering-policy["Cosa succede quando modifichi una policy di tiering dei volumi"]
...
** `none`
+
link:tiering-policies-concept.html["FabricPool policy di tiering dei volumi"]
