...
+
** Una volta esistenti aggregati HDD, selezionare *Storage > Tier* e fare clic su image:icon_kabob.gif["Opzioni di menu"] per l'aggregato su cui si desidera attivare il reporting dei dati inattivi.
