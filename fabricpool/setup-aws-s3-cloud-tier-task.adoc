...
+
Se ti serve capacità aggiuntiva in un sistema AFF, se utilizzi Amazon S3 su un sistema non AFF o se esegui l'upgrade da un cluster esistente, ti serve un link:https://docs.netapp.com/us-en/ontap/fabricpool/install-license-aws-azure-ibm-task.html["Licenza FabricPool"].
