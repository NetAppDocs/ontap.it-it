...
* A link:install-license-aws-azure-ibm-task.html["Licenza FabricPool"] è necessario quando si esegue il tiering su Azure Blob Storage da cluster ONTAP locali.
* Non è necessaria alcuna licenza se si utilizza Azure Blob Storage da Cloud Volumes ONTAP o Azure NetApp Files.
