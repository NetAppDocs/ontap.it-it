...
* A link:https://console.netapp.com/cloud-tiering["Licenza NetApp Cloud Tiering"^] è richiesto quando si effettua il tiering verso Alibaba Cloud Object Storage. Per ulteriori informazioni, consultare link:install-license-aws-azure-ibm-task.html["Installare una licenza FabricPool su un cluster ONTAP"].
