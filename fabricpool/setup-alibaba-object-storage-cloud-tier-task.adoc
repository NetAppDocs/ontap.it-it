...
* A link:install-license-aws-azure-ibm-task.html["Licenza FabricPool"] è necessario quando si esegue il tiering su Alibaba Cloud Object Storage da cluster ONTAP on-prem.
