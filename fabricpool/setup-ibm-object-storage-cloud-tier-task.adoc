...
+
I nuovi sistemi AFF ordinati sono dotati di 10 TB di capacità libera per l'utilizzo di FabricPool. Se si necessita di capacità aggiuntiva su un sistema AFF, se si utilizza lo storage a oggetti cloud IBM su un sistema non AFF o se si esegue l'aggiornamento da un cluster esistente, è necessaria una licenza FabricPool.
