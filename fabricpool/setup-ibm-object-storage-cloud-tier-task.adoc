...
* A link:install-license-aws-azure-ibm-task.html["Licenza FabricPool"] è necessario quando si esegue il tiering su IBM Cloud Object Storage da cluster on-prem.
