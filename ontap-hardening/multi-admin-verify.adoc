...
* link:https://docs.netapp.com/us-en/ontap/multi-admin-verify/enable-disable-task.html["Abilitazione della funzionalità di verifica multi-admin."]
...
. Quando un utente avvia l'operazione, a. link:https://docs.netapp.com/us-en/ontap/multi-admin-verify/request-operation-task.html["la richiesta viene generata."]
