...
---
= Risolvi i problemi hardware con ONTAP System Manager
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.2+| Piattaforma 11+| Supportato in Gestione di sistema nella versione ONTAP... 


| 9.18.1 | 9.17.1 | 9.16.1 | 9.15.1 | 9.14.1 | 9.13.1 | 9.12.1 | 9.11.1 | 9.10.1 | 9.9.1 | 9.8 (solo modalità di anteprima) 
...
Sì
 ...
 a| 
* Installa le patch più recenti per visualizzare questi dispositivi.
