...
A partire da ONTAP 9.19.1, le configurazioni FC e FC-NVMe con collegamento diretto sono supportate per alcuni sistemi AFF, ASA r2 e FAS. Le configurazioni con collegamento diretto non supportano la migrazione SMV.
