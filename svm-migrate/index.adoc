...
* I cluster di destinazione e di origine devono avere SnapMirror sincrono link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html["licenza installata"]. Questa licenza è inclusa con link:https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["ONTAP uno"].
...
| Relazioni di SnapMirror Cloud | ONTAP 9.12.1 | A partire da ONTAP 9.12.1, per migrare una SVM con relazioni SnapMirror Cloud, il cluster di destinazione deve disporre di link:https://docs.netapp.com/us-en/ontap/data-protection/snapmirror-licensing-concept.html#snapmirror-cloud-license["Licenza SnapMirror Cloud"] installato e deve avere sufficiente capacità a disposizione per supportare lo spostamento della capacità nei volumi su cui viene eseguito il mirroring nel cloud. 
