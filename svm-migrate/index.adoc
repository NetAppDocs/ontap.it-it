...
| Blocco delle copie Snapshot a prova di manomissione | ONTAP 9.14.1 | Il blocco delle copie Snapshot antimanomissione non è equivalente a SnapLock. SnapLock rimane non supportato. 
