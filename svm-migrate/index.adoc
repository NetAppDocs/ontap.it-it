...
* I cluster di origine e destinazione devono avere installata la licenza SnapMirror Synchronous.
...
| Relazioni copy-to-cloud asincrone di SnapMirror | ONTAP 9.12.1 | A partire da ONTAP 9.12.1, quando si migra una SVM con relazioni SnapMirror Copy to Cloud, il cluster di destinazione deve avere installata la licenza copy-to-cloud e deve avere sufficiente capacità a disposizione per supportare lo spostamento della capacità nei volumi in cui viene eseguito il mirroring nel cloud. 
