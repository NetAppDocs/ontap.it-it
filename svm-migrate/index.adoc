...
** Il cluster di destinazione esegue una versione di ONTAP uguale o successiva alla versione in esecuzione sul cluster di origine.
...
NOTE: La migrazione SVM non è supportata con FabricPool se l'origine o la destinazione sono un cluster MetroCluster.
