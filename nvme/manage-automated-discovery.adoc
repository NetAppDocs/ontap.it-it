...
summary: A partire da ONTAP 9.13.1, il rilevamento degli host dei controller tramite il protocollo NVMe TCP è automatizzato di default nelle reti basate su IP. 
---
