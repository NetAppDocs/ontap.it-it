...
* Puoi configurare la tua configurazione NVMe con nodi singoli o coppie ha utilizzando un fabric singolo o multi-fabric.
...
| 9.12.1  a| 
Configurazioni IP MetroCluster a 4 nodi su NVMe/FC.
...
== Piattaforme e nodi per cluster

I protocolli NVMe/FC e NVMe/TCP sono supportati come segue.


NOTE: NVME/FC è supportato sulle piattaforme elencate di seguito con HBA FC da 32GB GB.
