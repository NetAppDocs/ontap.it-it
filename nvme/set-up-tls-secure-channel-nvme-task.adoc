...
[role="lead"]
A partire da ONTAP 9.16.1, puoi configurare il canale sicuro TLS per le connessioni NVMe/TCP. Puoi usare System Manager o la ONTAP CLI per aggiungere un nuovo sottosistema NVMe con TLS abilitato oppure abilitare TLS per un sottosistema NVMe esistente. A partire da ONTAP 9.19.1, è supportato l'offload hardware TLS.
