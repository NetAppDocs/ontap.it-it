...
summary: 'Lo svuotamento manuale delle cache delle policy di esportazione rimuove le informazioni potenzialmente obsolete e obbliga ONTAP a recuperare le informazioni aggiornate dalle risorse esterne appropriate. Questo può contribuire a risolvere diversi problemi relativi all"accesso dei client alle esportazioni NFS.' 
---
