...
summary: 'È possibile abilitare o disabilitare NFSv4.1 modificando l"opzione -v4.1. Ciò consente l"accesso ai file per i client che utilizzano il protocollo NFSv4.1. In ONTAP 9.9.1, NFSv4.1 è abilitato per impostazione predefinita. Nelle versioni precedenti, è disabilitato per impostazione predefinita.' 
---
