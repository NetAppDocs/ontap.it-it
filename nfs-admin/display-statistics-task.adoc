...
summary: È possibile visualizzare le statistiche NFS per le macchine virtuali di storage sul sistema storage per monitorare le prestazioni e diagnosticare i problemi. 
---
