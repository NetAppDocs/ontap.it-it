...
summary: 'pNFS migliora le prestazioni consentendo ai client NFS di eseguire operazioni di lettura/scrittura sui dispositivi di storage direttamente e in parallelo, bypassando il server NFS come potenziale collo di bottiglia. Per abilitare o disabilitare pNFS, è possibile modificare l"opzione -v4.1-pnfs.' 
---
