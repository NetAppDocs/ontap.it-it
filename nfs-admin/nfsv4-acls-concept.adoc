...
summary: 'Un client che utilizza gli ACL NFSv4 può impostare e visualizzare gli ACL su file e directory del sistema. Quando viene creato un nuovo file o una sottodirectory in una directory che dispone di un ACL, il nuovo file o la nuova sottodirectory ereditano tutte le voci di controllo degli accessi presenti nell"ACL che sono state contrassegnate con i flag di ereditarietà appropriati.' 
---
