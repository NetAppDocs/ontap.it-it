...
summary: 'Kerberos offre un"autenticazione forte e sicura per le applicazioni client/server. L"autenticazione fornisce la verifica dell"identità di utenti e processi a un server. Nell"ambiente ONTAP, Kerberos fornisce l"autenticazione tra storage virtual machines e client NFS.' 
---
