...
sidebar: sidebar 
keywords:  
summary: 'È possibile abilitare i riferimenti NFSv4 sulle macchine virtuali di storage attivando le opzioni -v4-fsid-change e -v4.0-referrals o -v4.1-referrals. L"abilitazione dei riferimenti NFSv4 può comportare un accesso ai dati più rapido per i client NFSv4 che supportano questa funzionalità.' 
---
