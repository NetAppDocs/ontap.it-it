...
summary: 'Le policy di esportazione contengono una o più regole di esportazione che elaborano ogni richiesta di accesso del client. L"esito del processo determina se al client viene negato o concesso l"accesso e a quale livello. Affinché i client possano accedere ai dati, sulla macchina virtuale di storage deve esistere una policy di esportazione con regole di esportazione.' 
---
