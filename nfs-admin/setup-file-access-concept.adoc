...
summary: 'Per consentire ai client di accedere ai file sulle macchine virtuali di storage tramite NFS, è necessario completare una serie di passaggi. Alcuni passaggi aggiuntivi sono facoltativi e dipendono dalla configurazione corrente dell"ambiente.' 
---
