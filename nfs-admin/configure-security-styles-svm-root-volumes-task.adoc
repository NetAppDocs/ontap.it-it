...
summary: È possibile configurare lo stile di sicurezza del volume root della storage virtual machine per determinare il tipo di autorizzazioni utilizzate per i dati sul volume root della SVM. 
---
