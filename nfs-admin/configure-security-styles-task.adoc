...
summary: Configuri lo FlexVol volume security style per determinare il tipo di autorizzazioni utilizzate per i dati sui FlexVol volumes della storage virtual machine. 
---
