...
summary: ONTAP utilizza la semantica di sicurezza del file system di Windows NT per determinare se un utente UNIX, su un client NFS, ha accesso a un file con autorizzazioni NTFS. 
---
