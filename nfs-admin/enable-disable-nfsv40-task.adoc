...
summary: 'È possibile abilitare o disabilitare NFSv4.0 modificando l"opzione -v4.0. Ciò consente l"accesso ai file per i client che utilizzano il protocollo NFSv4.0. In ONTAP 9.9.1, NFSv4.0 è abilitato per impostazione predefinita. Nelle versioni precedenti, è disabilitato per impostazione predefinita.' 
---
