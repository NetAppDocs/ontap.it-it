...
summary: 'ONTAP crea e mantiene due nomi per i file o le directory in qualsiasi directory che abbia accesso da un client SMB: il nome lungo originale e un nome in formato 8.3.' 
---
