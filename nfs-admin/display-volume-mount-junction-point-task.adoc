...
summary: È possibile visualizzare informazioni sui volumi montati per le macchine virtuali di storage e sui punti di giunzione a cui sono montati i volumi. È inoltre possibile determinare quali volumi non sono montati su un punto di giunzione. Queste informazioni possono essere utilizzate per comprendere e gestire lo spazio dei nomi SVM. 
---
