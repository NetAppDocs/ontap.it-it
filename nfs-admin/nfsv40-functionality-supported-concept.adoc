...
*PRATICA CONSIGLIATA:* Si consiglia di utilizzare NFSv4.1 o NFSv4.2 al posto di NFSv4.0. NFSv4.0 è una versione precedente del protocollo NFS e non è più attivamente sviluppata dalla comunità NFS.
