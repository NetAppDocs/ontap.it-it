...
summary: È possibile abilitare o disabilitare il supporto per VMware vStorage su NFS sulle macchine virtuali di storage utilizzando il comando vserver nfs modify. 
---
