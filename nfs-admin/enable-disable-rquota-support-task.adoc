...
summary: Il protocollo quota remoto consente ai client NFS di ottenere informazioni sulle quote degli utenti da una macchina remota. Il supporto per le versioni di rquota varia a seconda della versione di ONTAP. 
---
