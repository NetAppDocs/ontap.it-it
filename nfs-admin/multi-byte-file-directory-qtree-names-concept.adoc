...
summary: A partire da ONTAP 9.5, il supporto per i nomi codificati in UTF-8 a 4 byte consente la creazione e la visualizzazione di nomi di file, directory e alberi che includono caratteri supplementari Unicode al di fuori del Basic Multilingual Plane. Nelle versioni precedenti, questi caratteri supplementari non venivano visualizzati correttamente negli ambienti multiprotocollo. 
---
