...
summary: 'Un volume deve essere montato nello spazio dei nomi NAS prima di poter configurare l"accesso del client NAS ai dati contenuti nei volumi della macchina virtuale di storage. È possibile montare un volume su un punto di giunzione se non è attualmente montato. È inoltre possibile smontare i volumi.' 
---
