...
summary: A partire da ONTAP 9.11.1, è possibile sfruttare la funzionalità _fast bind_ di LDAP per richieste di autenticazione del client più rapide e semplici. Per utilizzare questa funzionalità, il LDAP server deve supportare la funzionalità fast bind. 
---
