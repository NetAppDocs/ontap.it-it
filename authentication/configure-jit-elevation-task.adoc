...
* L'elevazione dei privilegi JIT è supportata solo per gli utenti che accedono tramite password, nsswitch o autenticazione di dominio. L'autenticazione a più fattori (MFA) non è supportata per l'elevazione dei privilegi JIT.
