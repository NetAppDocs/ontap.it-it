...
** È necessario abilitare OCSP per SSH. Consultare link:../system-admin/verify-digital-certificates-valid-ocsp-task.html["Verificare che i certificati digitali siano validi utilizzando OCSP"] per le istruzioni.
