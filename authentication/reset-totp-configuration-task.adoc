...
NOTE: A partire da ONTAP 9.19.1, devi inserire un codice TOTP valido o un codice scratch per eliminare la tua chiave segreta TOTP usando la CLI di ONTAP. Non puoi eliminare la tua chiave segreta TOTP usando la REST API di ONTAP.
