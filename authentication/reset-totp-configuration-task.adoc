...
NOTE: A partire da ONTAP 9.19.1, è necessario immettere un codice TOTP valido o un codice scratch per eliminare la chiave segreta TOTP tramite CLI. Non è possibile eliminare la chiave segreta TOTP tramite la REST API.
