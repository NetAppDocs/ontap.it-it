...
`-lower-challenge-boundary`
 a| 
La soglia percentuale minima per la verifica dell'autenticazione a più fattori (MFA). L'intervallo valido va da 0 a 99. Il valore 100 non è valido, poiché comporta il rifiuto di tutte le richieste. Il valore predefinito è 0.
 a| 
