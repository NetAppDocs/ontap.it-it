...
[NOTE]
====
Per gli account amministratore del cluster, l'autenticazione del certificato è supportata solo con `http` e. `ontapi` applicazioni. Per gli account amministratore SVM, l'autenticazione del certificato è supportata solo con `ontapi` applicazione.
