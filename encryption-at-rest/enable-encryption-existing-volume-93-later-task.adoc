...
summary: 'A partire da ONTAP 9.3, è possibile utilizzare il comando di avvio della conversione della crittografia del volume per abilitare la crittografia di un volume esistente "in uso", senza dover spostare il volume in una posizione diversa.' 
---
