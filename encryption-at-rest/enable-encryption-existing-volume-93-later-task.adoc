...
+
Per la sintassi completa dei comandi, vedere link:https://docs.netapp.com/us-en/ontap-cli-9131//volume-encryption-conversion-start.html["il riferimento del comando"^].
