...
`ontap-mediator-1.12.1`
 a| 
L'eseguibile di installazione del prodotto per la versione 1.12.1
...
`ontap-mediator-1.12.1.sig.tsr`
 a| 
La richiesta di revoca per l'utilizzo da parte di OCSP della firma dell'installatore
...
----
. Verifica i  `ontap-mediator-1.12.1.sig.tsr` e  `ontap-mediator-1.12.1.tsr` file utilizzando i certificati associati:
+
[role="tabbed-block"]
====
.OpenSSL 3.x
