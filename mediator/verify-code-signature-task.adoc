...
[NOTE]
====
* A partire dal 15 giugno 2025, non sarà possibile installare o aggiornare a ONTAP Mediator 1.9 e 1.8 perché i certificati di verifica della firma del codice sono scaduti. Invece, installa o aggiorna a ONTAP Mediator 1.11 o 1.10.
...
----
. Verifica i  `ontap-mediator-1.11.0.sig.tsr` e  `ontap-mediator-1.11.0.tsr` file utilizzando i certificati associati:
+
[role="tabbed-block"]
====
.OpenSSL 3.x
