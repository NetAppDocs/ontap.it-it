...
[NOTE]
====
* Dal 15 giugno 2025, non sarà più possibile installare o aggiornare ONTAP Mediator 1.9 e 1.8 perché i certificati di verifica della firma digitale sono scaduti. Installare o aggiornare ONTAP Mediator 1.10.
