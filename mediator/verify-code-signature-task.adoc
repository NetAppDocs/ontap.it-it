...
[NOTE]
====
* A partire dal 15 giugno 2025, non sarà possibile installare o aggiornare a ONTAP Mediator 1.9 e 1.8 perché i certificati di verifica della firma del codice sono scaduti. Invece, installa o aggiorna ONTAP Mediator alla versione 1.10 o successiva.
