...
Oracle Linux 10.x
 a| 
** ol-10-for-x86_64-baseos-rpms
** ol-10-for-x86_64-appstream-rpms
...
Oracle Linux 9.x
 a| 
** ol-9-for-x86_64-baseos-rpms
** ol-9-for-x86_64-appstream-rpms
...
.Procedura per il sistema operativo Oracle Linux 10.x
[#OL10x%collapsible]
====
Utilizza questa procedura se il tuo sistema operativo è *Oracle Linux 10.x* per abilitare l'accesso ai repository:
...
[source, cli]
----
subscription-manager repos --enable ol-10-for-x86_64-baseos-rpms
----
+
[source, cli]
----
subscription-manager repos --enable ol-10-for-x86_64-appstream-rpms
----
+
...
[listing]
----
[root@localhost ~]# subscription-manager repos --enable ol-10-for-x86_64-baseos-rpms
Repository 'ol-10-for-x86_64-baseos-rpms' is enabled for this system.
[root@localhost ~]# subscription-manager repos --enable ol-10-for-x86_64-appstream-rpms
Repository 'ol-10-for-x86_64-appstream-rpms' is enabled for this system.
----
...
====
.Procedura per il sistema operativo Oracle Linux 9.x
[#OL9x%collapsible]
====
Utilizza questa procedura se il tuo sistema operativo è *Oracle Linux 9.x* per abilitare l'accesso ai repository:
...
[source, cli]
----
subscription-manager repos --enable ol-9-for-x86_64-baseos-rpms
----
+
[source, cli]
----
subscription-manager repos --enable ol-9-for-x86_64-appstream-rpms
----
+
Nell'esempio seguente viene illustrata l'esecuzione di questo comando:
...
[listing]
----
[root@localhost ~]# subscription-manager repos --enable ol-9-for-x86_64-baseos-rpms
Repository 'ol-9-for-x86_64-baseos-rpms' is enabled for this system.
[root@localhost ~]# subscription-manager repos --enable ol-9-for-x86_64-appstream-rpms
Repository 'ol-9-for-x86_64-appstream-rpms' is enabled for this system.
----
. Eseguire `yum repolist` comando.
+
I repository appena sottoscritti dovrebbero apparire nell'elenco.
