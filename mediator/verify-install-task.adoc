...
summary: Dopo aver installato ONTAP Mediator, è necessario verificare che ONTAP Mediator sia in esecuzione. 
---
= Verificare lo stato dell'installazione di ONTAP Mediator
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
