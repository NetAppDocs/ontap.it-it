...
[CAUTION]
====
* I certificati di terze parti sono supportati solo con ONTAP Mediator su alcune versioni di ONTAP. Vedere link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/JiraNgage/CONTAP-243278["ID bug online di NetApp CONTAP-243278"^].
