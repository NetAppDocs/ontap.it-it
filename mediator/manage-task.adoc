...
[NOTE]
====
* In ONTAP Mediator 1,8 e versioni precedenti, i file CA utilizzati sono: `ca.key`, `ca.csr`, `ca.srl` E `ca.crt`. A partire da ONTAP Mediator 1,9, i file richiesti sono `intermediate.key`, `intermediate.csr`, `intermediate.srl` e `intermediate.crt`.
