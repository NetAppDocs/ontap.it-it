...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["Due"]link:upgrade-host-os-mediator-task.html["Aggiorna il sistema operativo host e il mediatore"]
[role="quick-margin-para"]
Se stai aggiornando una versione esistente di ONTAP Mediator, devi prima disinstallare la versione precedente e poi installare quella nuova. Se stai installando ONTAP Mediator per la prima volta, puoi saltare questo passaggio.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png["Sei"]link:install-mediator-pkg-task.html["Installare ONTAP Mediator"]
[role="quick-margin-para"]
