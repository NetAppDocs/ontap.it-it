...
summary: 'Per installare ONTAP Mediator, è necessario ottenere il pacchetto di installazione ed eseguire il programma di installazione sull"host.' 
---
...
.Esempio di installazione di ONTAP Mediator (uscita console)
[%collapsible]
====
[listing]
----
