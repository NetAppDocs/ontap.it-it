...
+
In alternativa, è possibile utilizzare l' `--https-only`opzione nel `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y`comando per specificare solo HTTPS.
...
+
`./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y`

+
[listing]
----
[root@mediator_host ~]# ./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y
----
+
[NOTE]
====
Per saltare il controllo della firma durante l'installazione, utilizzare questo comando: `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y --skip-code-signature-check`
