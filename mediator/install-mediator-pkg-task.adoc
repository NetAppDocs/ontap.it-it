...
NOTE: Per saltare il controllo automatico della firma durante l'installazione, utilizzare il seguente comando: `./ontap-mediator-1.9.1/ontap-mediator-1.9.1 -y --skip-code-signature-check`
