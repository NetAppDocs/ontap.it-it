...
NOTE: Per saltare il controllo automatico della firma durante l'installazione, utilizzare il seguente comando:  `./ontap-mediator-1.10/ontap-mediator-1.10 -y --skip-code-signature-check`
