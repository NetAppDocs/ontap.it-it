...
summary: 'Per installare ONTAP Mediator, è necessario scaricare il pacchetto di installazione ed eseguire il programma di installazione sull"host.' 
---
...
[role="lead"]
Per installare ONTAP Mediator, è necessario scaricare il pacchetto di installazione ed eseguire il programma di installazione sull'host.
...
NOTE: Per saltare il controllo della firma durante l'installazione, utilizzare questo comando: `./ontap-mediator-1.11.0/ontap-mediator-1.11.0 -y --skip-code-signature-check`
...
.Esempio di installazione di ONTAP Mediator (output della console)
[%collapsible]
====
[listing]
----
