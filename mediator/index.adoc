...
[CAUTION]
====
* Quando ONTAP Mediator è configurato con il protocollo HTTPS nelle configurazioni IP di MetroCluster, una singola istanza di ONTAP Mediator può monitorare una sola configurazione IP di MetroCluster. Il monitoraggio simultaneo di più configurazioni IP MetroCluster non è supportato.
