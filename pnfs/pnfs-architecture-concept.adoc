...
::*> pnfs devices mappings show -vserver DEMO
...
NOTE: In questi comandi, i nomi dei volumi non sono presenti. Invece, vengono utilizzati gli ID numerici associati a tali volumi: il MSID e il DSID. Per trovare i volumi associati alle mappature, puoi usare  `volume show -dsid [dsid_numeric]` o  `volume show -msid [msid_numeric]` nei privilegi avanzati della CLI di ONTAP.
...
* https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["Rapporto tecnico NetApp 4571: Best practice FlexGroup"^]
