...
summary: 'Per installare il software, è necessario scaricare il file di installazione dell"appliance virtuale e quindi utilizzare un client VMware vSphere per distribuire il file su un server VMware ESXi. L"appliance virtuale è disponibile in un file OVA.' 
---
