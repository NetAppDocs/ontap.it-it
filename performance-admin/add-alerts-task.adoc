...
sidebar: sidebar 
keywords: add, alerts 
summary: Gli eventi sono notifiche che Active IQ Unified Manager genera automaticamente quando si verifica una condizione predefinita o quando il valore di un contatore delle prestazioni supera una soglia. Gli eventi ti aiutano a identificare i problemi di prestazioni nei cluster che stai monitorando. 
---
= Aggiungi avvisi ONTAP Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Gli eventi sono notifiche che Active IQ Unified Manager genera automaticamente quando si verifica una condizione predefinita o quando il valore di un contatore delle prestazioni supera una soglia. Gli eventi ti aiutano a identificare i problemi di prestazioni nei cluster che stai monitorando.

È possibile configurare degli avvisi per essere avvisati quando viene generato un evento specifico. È possibile configurare gli avvisi per una singola risorsa, per un gruppo di risorse o per eventi di un tipo di gravità specifico. È possibile specificare la frequenza di notifica e associare uno script all'avviso.
