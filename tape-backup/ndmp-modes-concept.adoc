...
summary: 'È possibile scegliere di eseguire operazioni di backup su nastro e ripristino su nastro a livello di nodo o a livello di macchina virtuale di storage (SVM). Per eseguire correttamente queste operazioni a livello di SVM, il servizio NDMP deve essere abilitato sulla SVM.' 
---
