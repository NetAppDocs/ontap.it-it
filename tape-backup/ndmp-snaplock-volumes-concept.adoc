...
summary: La creazione di più copie di dati regolamentati offre scenari di ripristino ridondanti e, grazie al dump e al ripristino NDMP, è possibile preservare le caratteristiche di scrittura una sola volta, lettura molte volte dei file sorgente su un SnapLock volume. 
---
