...
summary: Il Network Data Management Protocol è un protocollo standardizzato per il controllo del backup, del ripristino e di altri tipi di trasferimento dati tra dispositivi di storage primari e secondari, come sistemi storage e librerie a nastro. 
---
