...
summary: Il numero massimo di thread di input/output per unità a nastro locali attivi è attualmente in uso. È possibile avere un massimo di 16 unità a nastro locali attive. 
---
