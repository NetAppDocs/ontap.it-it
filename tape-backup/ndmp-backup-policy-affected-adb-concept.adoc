...
summary: 'Quando il bilanciatore automatico dei dati è abilitato, il bilanciatore analizza le statistiche di utilizzo degli aggregati per identificare l"aggregato che ha superato la percentuale di utilizzo di soglia elevata configurata.' 
---
