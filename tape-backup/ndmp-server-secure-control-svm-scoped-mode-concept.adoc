...
summary: 'È possibile stabilire una connessione di controllo sicura tra l"applicazione di gestione dei dati e il server NDMP utilizzando socket sicuri come meccanismo di comunicazione. Questa comunicazione SSL si basa sui certificati del server.' 
---
