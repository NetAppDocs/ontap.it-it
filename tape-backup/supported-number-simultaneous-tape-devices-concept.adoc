...
summary: ONTAP supporta un massimo di 64 connessioni simultanee di disco a nastro, 16 cambia supporti e 16 dispositivi bridge o router per ciascun sistema storage, in qualsiasi combinazione di connessioni Fibre Channel, SCSI o SAS. 
---
