...
summary: 'Nella modalità NDMP a livello di macchina virtuale di storage, i tipi di connessione dati NDMP supportati dipendono dal tipo di LIF della connessione di controllo NDMP e dallo stato dell"estensione CAB. Questo tipo di connessione dati NDMP indica se è possibile eseguire un"operazione di backup o ripristino NDMP locale o a tre vie.' 
---
