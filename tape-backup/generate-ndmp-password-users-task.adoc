...
summary: 'Nella modalità NDMP a livello di storage virtual machine, è necessario generare una password per uno specifico ID utente. La password generata si basa sulla password di accesso effettiva dell"utente NDMP. Se la password di accesso effettiva cambia, è necessario generare nuovamente la password specifica per NDMP.' 
---
