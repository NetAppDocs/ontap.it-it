...
summary: 'ONTAP supporta due motori di backup: SMTape e dump. È importante conoscere i casi d"uso dei motori di backup SMTape e dump per aiutarti a scegliere il motore di backup per eseguire le operazioni di backup su nastro e ripristino.' 
---
