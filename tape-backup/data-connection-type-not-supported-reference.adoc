...
summary: Nella modalità NDMP a livello di nodo, la connessione dati NDMP stabilita deve avere lo stesso tipo di indirizzo di rete della connessione di controllo NDMP. 
---
