...
summary: 'Durante l"esecuzione delle operazioni di backup e ripristino SMTape tramite NDMP o CLI, è necessario essere consapevoli del numero massimo di sessioni di backup e ripristino SMTape che possono essere eseguite simultaneamente su sistemi storage con diverse capacità di memoria di sistema. Questo numero massimo dipende dalla memoria di sistema di un sistema storage.' 
---
