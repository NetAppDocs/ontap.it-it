...
summary: 'È possibile utilizzare la funzionalità di recovery migliorata per il ripristino ad accesso diretto (DAR) di directory, file e flussi NT. Per impostazione predefinita, la funzionalità DAR migliorata è abilitata.' 
---
