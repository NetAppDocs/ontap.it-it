...
summary: 'L"utilizzo degli alias semplifica il processo di identificazione dei dispositivi. Gli alias associano il nome di un percorso fisico o il numero di serie di un nastro o di un cambia supporti a un nome alias persistente, ma modificabile.' 
---
