...
summary: 'CAB è un"estensione del protocollo NDMP v4. Questa estensione consente al server NDMP di stabilire una connessione dati su un nodo che possiede un volume. Questo consente inoltre all"applicazione per il backup di determinare se i volumi e i dispositivi a nastro si trovano sullo stesso nodo in un cluster.' 
---
