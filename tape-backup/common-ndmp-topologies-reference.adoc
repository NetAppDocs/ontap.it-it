...
summary: NDMP supporta diverse topologie e configurazioni tra applicazioni per il backup e sistemi storage o altri server NDMP che forniscono servizi dati e servizi su nastro. 
---
