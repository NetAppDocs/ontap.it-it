...
summary: ONTAP supporta il backup su nastro e il ripristino tramite Network Data Management Protocol. NDMP consente di eseguire il backup dei dati nei sistemi storage direttamente su nastro, con conseguente utilizzo efficiente della larghezza di banda di rete. ONTAP supporta sia il motore dump che il motore SMTape per il backup su nastro. 
---
