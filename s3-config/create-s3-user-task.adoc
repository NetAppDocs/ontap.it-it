...
Per una maggiore sicurezza, a partire da ONTAP 9.15.1, le chiavi di accesso e le chiavi segrete vengono visualizzate solo al momento della creazione dell'utente S3 e non possono essere visualizzate nuovamente. In caso di smarrimento delle chiavi, occorre generare nuove chiavi ricreando l'utente.
