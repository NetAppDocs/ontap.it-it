...
Come per altri protocolli quali FC, iSCSI, NFS, NVMe_oF e SMB, S3 richiede l'installazione di una licenza prima di poter essere utilizzato in ONTAP. La licenza S3 è una licenza a costo zero, ma deve essere installata sui sistemi che eseguono l'aggiornamento a ONTAP 9.8. La licenza S3 può essere scaricata dal link:https://mysupport.netapp.com/site/systems/master-license-keys/ontaps3["pagina delle chiavi di licenza"^] sul sito di supporto NetApp.
