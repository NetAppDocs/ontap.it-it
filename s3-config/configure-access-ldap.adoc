...
=== Il metodo di autenticazione è nsswitch e LDAP è abilitato esempio:
...
(Possibile se LDAP è disattivato o se gli utenti non POSIX non sono configurati UID e GID).
