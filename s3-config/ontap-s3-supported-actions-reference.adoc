...
.ONTAP 9.11.1
ONTAP 9.11,1 aggiunge il supporto per le versioni, gli URL pre-firmati, i caricamenti a blocchi e il supporto per le azioni S3 comuni, come la creazione e l'eliminazione di bucket tramite API S3.
...
.ONTAP 9.10.1
ONTAP 9.10,1 aggiunge il supporto per S3 SnapMirror e GetBucketLocation.
