...
NOTE: Se LDAP è disattivato, è possibile utilizzare link:../smb-config/create-server-active-directory-domain-task.html["Active Directory e SMB con autenticazione basata su dominio"] per generare le chiavi di accesso.
