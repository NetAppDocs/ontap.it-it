...
....
.Causa:
Il failover pianificato non può iniziare quando è in corso un'operazione senza interruzioni, inclusi lo spostamento del volume, il trasferimento degli aggregati e il failover dello storage.
