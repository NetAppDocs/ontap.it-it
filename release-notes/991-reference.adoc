...
| link:../nfs-admin/ldaps-concept.html["Supporto LDAP su qualsiasi porta"] | LDAPS può essere configurato su qualsiasi porta, anche se la porta 636 rimane l'impostazione predefinita. 
