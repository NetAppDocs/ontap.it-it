...
| Aggiornare | Descrizione 
 ...
 a| 
xref:../anti-ransomware/index.html[Supporto hypervisor aggiuntivo]
 a| 
A partire da ONTAP 9.17.1P5, Autonomous Ransomware Protection supporta Hyper-V, KVM e OpenStack hypervisor.



 a| 
xref:../anti-ransomware/index.html[Aggiornamenti snapshot di Autonomous Ransomware Protection]
 a| 
ONTAP introduce diversi aggiornamenti agli snapshot ARP/AI.
