...
A partire da ONTAP 9.17.1P5, Autonomous Ransomware Protection supporta Hyper-V, KVM e OpenStack hypervisor.
 ...
 a| 
xref:../anti-ransomware/index.html[Aggiornamenti snapshot della protezione autonoma dai ransomware]
 a| 
ONTAP introduce diversi aggiornamenti agli snapshot ARP.
