...
A partire da ONTAP 9.12.1, System Manager è integrato con NetApp Console. Scopri di più su xref:../sysmgr-integration-console-concept.html[Integrazione di System Manager con NetApp Console] .
