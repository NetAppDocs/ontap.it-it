...
* xref:../anti-ransomware/support-arpai.html#multi-admin-verification-with-arp-ai-protected-volumes[Verifica della funzionalità degli amministratori multipli con la protezione autonoma dal ransomware]
