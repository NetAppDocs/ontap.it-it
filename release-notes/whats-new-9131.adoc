...
| xref:../snaplock/snapshot-lock-concept.html[Blocco delle copie Snapshot a prova di manomissione] | Puoi utilizzare System Manager per bloccare una copia Snapshot su un volume non SnapLock e fornire protezione contro gli attacchi ransomware. 
