...
+
Estende la protezione autonoma contro i ransomware (ARP/AI) a SnapMirror synchronous per ambienti SAN e NAS e SnapMirror active sync SAN, preservando i segnali di rilevamento e ripristino nelle architetture zero‑RPO. 
