...
| Protezione ransomware autonoma (ARP) | ARP/AI viene abilitato automaticamente per impostazione predefinita su tutti i nuovi volumi dopo un grace period di 12 ore sulle piattaforme supportate. | ONTAP 9.18.1 
