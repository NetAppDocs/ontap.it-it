...
| xref:../snapmirror-active-sync/index.html[Miglioramenti alla continuità della sincronizzazione attiva di SnapMirror] | La sincronizzazione attiva di SnapMirror supporta il ripristino parziale del LUN da Snapshot. Inoltre, la sincronizzazione attiva di SnapMirror estende la QoS ai volumi non nella relazione di SnapMirror. 
