...
| Nell'API REST di ONTAP, i gruppi di coerenza supportano una procedura di snapshot a due fasi, che ti permette di effettuare un precheck prima di confermare lo snapshot. 
|===
