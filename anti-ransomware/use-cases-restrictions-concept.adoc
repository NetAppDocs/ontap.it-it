...
ARP è supportato per le configurazioni MetroCluster a partire da ONTAP 9.10.1.
...
A partire da ONTAP 9.12.1, ARP è supportato sui volumi di destinazione asincroni SnapMirror . ARP _non_ è supportato con SnapMirror sincrono o SnapMirror ActiveSync.
