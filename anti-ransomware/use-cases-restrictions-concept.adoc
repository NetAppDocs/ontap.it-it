...
* A partire da ONTAP 9.10.1 fino a 9.15.1, i carichi di lavoro NAS su volumi con più di 4.000 estensioni di file univoche.
+
Il modello ARP originale è in grado di analizzare fino a 4.000 estensioni di file per volume. Se il numero di estensioni di file univoche su un volume supera questo limite, ARP non può rilevare efficacemente l'attività ransomware e il carico di lavoro viene considerato non idoneo per ARP. Questo limite non si applica ad ARP/AI a partire da ONTAP 9.16.1.
