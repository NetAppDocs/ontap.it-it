...
* Le analisi ARP/AI vengono eseguite sul volume attivo di lettura/scrittura nelle relazioni SAN SnapMirror synchronous e SnapMirror active sync. ARP crea snapshot sul volume primario ed esegue il rilevamento di ransomware basato su machine learning.
* Gli snapshot ARP non vengono replicati sul volume secondario nelle relazioni SnapMirror synchronous o SnapMirror active sync. Devi link:enable-task.html["riattivare ARP"] sul volume di ripristino dopo il failover.
