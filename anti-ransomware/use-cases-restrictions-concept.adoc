...
* Dopo l'aggiornamento a ONTAP 9.19.1 RC e l'abilitazione di ARP sui volumi che fanno parte di relazioni SnapMirror synchronous o SnapMirror active sync, la relazione potrebbe trovarsi brevemente in uno stato di non sincronizzazione. Questa condizione è temporanea e la relazione dovrebbe risincronizzarsi automaticamente senza alcun intervento.
