...
[role="lead"]
Per gli ambienti NAS, è possibile commutare manualmente o automaticamente un volume abilitato per ARP dalla modalità di apprendimento alla modalità attiva. Sarà necessario cambiare modalità se si utilizza ARP con ONTAP 9.15.1 e versioni precedenti o se ARP è in esecuzione su volumi FlexGroup con ONTAP 9.17.1 e versioni precedenti.
...
Se si utilizza ARP con protezione ARP/AI, ARP diventa attivo automaticamente. Non è richiesto alcun periodo di apprendimento.
...
Per ONTAP dalla versione 9.10.1 alla 9.15.1 (ONTAP 9.17.1 e versioni precedenti con volumi FlexGroup ), è possibile passare manualmente dalla modalità di apprendimento ARP alla modalità attiva utilizzando System Manager o ONTAP CLI una volta completato il periodo di apprendimento.
