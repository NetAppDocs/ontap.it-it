...
.Modalità attiva
Per ARP in esecuzione con ONTAP 9.10,1 a 9.15.1, ARP passa alla _modalità attiva_ una volta completato l'intervallo di apprendimento ottimale. Dopo che ARP è passato alla modalità attiva, ONTAP crea istantanee ARP per proteggere i dati se viene rilevata una minaccia.
