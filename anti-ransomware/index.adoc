...
* *SnapMirror sincronizzazione sincrona e attiva*: A partire da ONTAP 9.19.1 RC, gli snapshot ARP creati per i volumi che partecipano a SnapMirror sincronizzazione sincrona o SnapMirror active sync relazioni seguono queste regole aggiuntive:
+
