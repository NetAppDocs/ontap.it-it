---
sidebar: sidebar 
permalink: anti-ransomware/update-arpai.html 
keywords: ARP AI, arpai, update, autonomous ransomware protection AI, security files, security package, security updates, security bundle, automatic update, manual update, ONTAP 9.16.1, machine learning ransomware, update ransomware model ONTAP, ARP AI security bundle update, automatic ransomware security updates 
summary: Mantieni aggiornata la protezione ARP/AI contro le più recenti minacce ransomware aggiornando automaticamente o manualmente i pacchetti di sicurezza ARP/AI, indipendentemente dalla cadenza di rilascio di ONTAP. 
---
...
NOTE: ARP (ONTAP 9.10.1 a 9.15.1) non supporta gli aggiornamenti automatici del modello di sicurezza. Le funzionalità di rilevamento della sicurezza vengono aggiornate solo con gli aggiornamenti del software ONTAP. Se stai utilizzando ONTAP 9.15.1 o versioni precedenti, vedi link:index.html["Scopri di più sulla protezione autonoma dal ransomware"].
...
NOTE: Assicurati di installare solo un aggiornamento ARP/AI più recente rispetto alla versione attualmente in uso per evitare eventuali downgrade indesiderati di ARP/AI.
...
* link:learn-about-arpai.html["Scopri di più su ARP/AI"]
